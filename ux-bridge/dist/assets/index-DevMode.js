    ...
    <main class="auth-layout">
      <section class="auth-card">
        <div class="auth-card__intro">
          <a class="brand-mark brand-mark--solo" href="./index.html" aria-label="UX Bridge login">
            <span class="brand-mark__icon" aria-hidden="true">
              <svg viewBox="0 0 32 32">
                <path d="M16 4C9.372 4 4 9.372 4 16c0 6.627 5.372 12 12 12 6.627 0 12-5.373 12-12C28 9.372 22.627 4 16 4Z" />
                <path d="M10.4 16c1.6-4.4 4.1-6.6 5.6-6.6s4 2.2 5.6 6.6c-1.6 4.4-4.1 6.6-5.6 6.6s-4-2.2-5.6-6.6Z" />
                <path d="M7.5 12.3c3.8.2 6.8 1.4 8.5 3.7-1.7 2.3-4.7 3.5-8.5 3.7" />
                <path d="M24.5 12.3c-3.8.2-6.8 1.4-8.5 3.7 1.7 2.3 4.7 3.5 8.5 3.7" />
              </svg>
            </span>
          </a>
          <p class="auth-card__eyebrow">Protected Access</p>
          <h1>Sign in to UX Bridge</h1>
          <p class="auth-card__copy">
            Access is limited to Nu Skin team members using a valid <strong>@nuskin.com</strong> or
            <strong>@NuSkin.onmicrosoft.com</strong> email address.
          </p>
        </div>

        <div class="auth-switcher" role="tablist" aria-label="Authentication mode">
          <button type="button" class="auth-switcher__tab is-active" data-auth-tab="login" aria-pressed="true">
            Sign In
          </button>
          <button type="button" class="auth-switcher__tab" data-auth-tab="signup" aria-pressed="false">
            Create Account
          </button>
        </div>
        ...
        <section class="auth-panel" data-auth-panel="login">
          <form class="auth-form" data-auth-form="login">
            <button class="auth-sso" type="button" data-auth-sso hidden>
              <span class="auth-sso__icon" aria-hidden="true">
            ...
            <div class="auth-inline">
              <button class="auth-link" type="button" data-auth-mode-link="forgot">Forgot password?</button>
            </div>
        ...
        <section class="auth-panel" data-auth-panel="forgot" hidden>
          <form class="auth-form" data-auth-form="requestPasswordReset">
            <label class="auth-field">
              <span>Nu Skin Email</span>
              <input type="email" name="email" inputmode="email" autocomplete="email" required />
            </label>
            <p class="auth-hint">
              Enter your Nu Skin email and we’ll send you a password reset link if the account exists.
            </p>
            <p class="auth-status" data-auth-status aria-live="polite"></p>
            <button class="auth-submit" type="submit">Send Reset Link</button>
            <button class="auth-secondary" type="button" data-auth-mode-link="login">Back to Sign In</button>
          </form>
        </section>
      </section>
    </main>
...
<html lang="en" style="visibility: hidden">
  ...
  <body class="bridge-body">
    <div class="bridge-layout" data-bridge-shell hidden>
      <aside class="bridge-sidebar">
        <a class="bridge-sidebar__brand" href="./projects.html" data-home-link="true" aria-label="UX Bridge home">
          <span class="bridge-sidebar__brand-mark">B</span>
          <span>
            <strong>UX Bridge</strong>
            <small>Project workspace</small>
          </span>
        </a>

        <nav class="bridge-sidebar__nav" aria-label="Main navigation">
          <a class="bridge-sidebar__link is-active" href="./projects.html" data-home-link="true">
            <span>Projects</span>
          </a>
          <a class="bridge-sidebar__link" href="./user-management.html" data-admin-link hidden data-admin-only="true">
            <span>Admin</span>
          </a>
        </nav>

        <div class="bridge-sidebar__user-menu">
          <button class="bridge-sidebar__user-trigger" type="button" aria-haspopup="menu">
            <span class="bridge-sidebar__user-avatar" data-auth-user-avatar aria-hidden="true">U</span>
            <span class="bridge-sidebar__user-meta">
              <strong data-auth-user-name>User</strong>
              <span data-auth-user-email>user@nuskin.com</span>
            </span>
          </button>
          <div class="bridge-sidebar__user-popover" role="menu" aria-label="User menu">
            <a class="bridge-sidebar__user-menu-item" href="./profile.html" data-profile-link="true" role="menuitem">
              Profile
            </a>
            <button class="bridge-sidebar__user-menu-item" type="button" data-auth-logout role="menuitem">
              Sign out
            </button>
          </div>
        </div>
      ...
      <main class="bridge-main bridge-main--admin">
        <section class="bridge-hero">
          <div class="bridge-hero__head">
            <div class="bridge-hero__copy">
              <p class="bridge-hero__eyebrow">UX Bridge</p>
              <h1>Projects</h1>
              <p>Open a project or start a new one.</p>
            </div>
            <div class="bridge-hero__actions" data-projects-hero-actions></div>
          </div>
        </section>

        <section class="bridge-projects" data-projects-root>
          <article class="bridge-project-card">
            <div class="bridge-project-card__meta">
              <p class="bridge-project-card__eyebrow">Loading</p>
...
<html lang="en" style="visibility: hidden">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>UX Bridge | Admin Workspace</title>
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link
      href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap"
  ...
  <body class="bridge-body">
    <div class="bridge-layout" data-bridge-shell hidden>
      <aside class="bridge-sidebar">
        ...
        <nav class="bridge-sidebar__nav" aria-label="Main navigation">
          <a class="bridge-sidebar__link" href="./projects.html" data-home-link="true">
            <span>Projects</span>
          </a>
          <a class="bridge-sidebar__link is-active" href="./user-management.html" data-admin-link hidden data-admin-only="true">
            <span>Admin</span>
          </a>
        </nav>
      ...
      <main class="bridge-main bridge-main--admin">
        <section class="bridge-hero">
          <div class="bridge-hero__head">
            <div class="bridge-hero__copy">
              <p class="bridge-hero__eyebrow">Admin Workspace</p>
              <h1>Admin control center</h1>
              <p>
                Manage user access, review activity, monitor system issues, and use recovery tools for UX Bridge.
              </p>
            </div>
            <div class="bridge-hero__actions bridge-admin-hero__actions" data-admin-hero-actions></div>
          </div>
        </section>

        <section class="bridge-admin" data-admin-users-app>
...
<html lang="en" style="visibility: hidden">
  ...
  <body class="bridge-body">
    <div class="bridge-layout" data-bridge-shell hidden>
      ...
      <main class="bridge-main bridge-main--admin">
        <section class="bridge-hero">
          <p class="bridge-hero__eyebrow">Profile</p>
          <h1>User profile</h1>
          <p>Manage account details, profile photo, and password reset access for UX Bridge.</p>
        </section>

        <section class="bridge-profile" data-profile-app>
...
<html lang="en" style="visibility: hidden">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Reset Password | UX Bridge</title>
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link
      href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap"
    ...
    <main class="auth-layout">
      <section class="auth-card">
        <div class="auth-card__intro">
          ...
          <p class="auth-card__copy">
            Choose a new password for your UX Bridge account. This reset link is time-limited for your security.
          </p>
        </div>
        ...
        <form class="auth-form" data-reset-form>
          ...
          <p class="auth-status" data-reset-status aria-live="polite"></p>
          <button class="auth-submit" type="submit">Set New Password</button>
          <a class="auth-secondary auth-secondary--link" href="./index.html">Back to Sign In</a>
        </form>
      </section>
    </main>
...
<html lang="en" style="visibility: hidden">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>UX Bridge | Brand Affiliate Overview</title>
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link
      href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap"
  ...
  <body
    class="bridge-body bridge-body--project"
    data-project-key="brand-affiliate-mobile"
    data-page-key="overview"
    data-page-label="Project Overview"
  >
    <div class="bridge-layout bridge-layout--project" data-bridge-shell hidden>
      <aside class="bridge-sidebar" data-bridge-sidebar>
        <a class="bridge-sidebar__brand" href="./projects.html" data-home-link="true" aria-label="UX Bridge home">
          <span class="bridge-sidebar__brand-mark">B</span>
          <span>
            <strong>UX Bridge</strong>
        ...
        <nav class="bridge-sidebar__nav" aria-label="Project pages">
          <a class="bridge-sidebar__link is-active" href="./project-overview.html" data-project-page-key="overview">
            <span class="bridge-sidebar__label">Project Overview</span>
          </a>
          <div class="bridge-sidebar__nav-divider" aria-hidden="true"></div>
          <p class="bridge-sidebar__project-label bridge-sidebar__nav-label">Pages</p>
          <div class="bridge-sidebar__nav-pages" data-project-nav-pages>
            <div class="bridge-sidebar__nav-item" data-project-page-item="building">
              <a class="bridge-sidebar__link" href="./building-preview.html" data-project-page-key="building">
                <span class="bridge-sidebar__drag" draggable="true" aria-label="Reorder Building page" role="button" tabindex="0">
                ...
                <span class="bridge-sidebar__label">Building</span>
              </a>
            </div>
            <div class="bridge-sidebar__nav-item" data-project-page-item="l1-bonus">
              <a class="bridge-sidebar__link" href="./l1-bonus-preview.html" data-project-page-key="l1-bonus">
                <span class="bridge-sidebar__drag" draggable="true" aria-label="Reorder L1 Bonus page" role="button" tabindex="0">
                  <svg viewBox="0 0 20 20" aria-hidden="true">
                    <circle cx="7" cy="6" r="1.2" />
                    <circle cx="13" cy="6" r="1.2" />
                    <circle cx="7" cy="10" r="1.2" />
                ...
                <span class="bridge-sidebar__label">L1 Bonus</span>
              </a>
            </div>
            <div class="bridge-sidebar__nav-item" data-project-page-item="l1-l2-bonus">
              <a class="bridge-sidebar__link" href="./l1-l2-bonus-preview.html" data-project-page-key="l1-l2-bonus">
                <span class="bridge-sidebar__drag" draggable="true" aria-label="Reorder L1/L2 Bonus page" role="button" tabindex="0">
                  <svg viewBox="0 0 20 20" aria-hidden="true">
                    <circle cx="7" cy="6" r="1.2" />
                    <circle cx="13" cy="6" r="1.2" />
                    <circle cx="7" cy="10" r="1.2" />
                ...
                <span class="bridge-sidebar__label">L1/L2 Bonus</span>
              </a>
            </div>
          </div>
        </nav>
      ...
      <button class="bridge-sidebar-backdrop" type="button" aria-label="Close navigation" data-nav-backdrop></button>

      <section class="bridge-main bridge-main--project">
        <header class="bridge-project-toolbar">
          <div class="bridge-project-toolbar__heading">
            <button class="bridge-nav-toggle" type="button" aria-label="Open navigation" aria-expanded="false" data-nav-toggle>
            ...
            <div>
              <p class="bridge-back-link">
                <a href="./projects.html" data-home-link="true">Projects</a>
                <span>|</span>
                <span data-project-name>Brand Affiliate Mobile</span>
              </p>
              <h1 data-static-project-page-title>Project Overview</h1>
            </div>
          </div>
          <div class="bridge-project-toolbar__actions" data-header-actions></div>
        </header>
        <div class="bridge-project-side-actions" data-side-actions></div>

        <main class="bridge-overview">
          <section class="bridge-overview__hero">
            <p class="bridge-hero__eyebrow">Project snapshot</p>
            <h2>Brand Affiliate Mobile</h2>
            <p>
              A mobile prototype inside UX Bridge with live previews, page-level customizer controls, active viewer
              presence, and durable page ordering.
            </p>
          </section>

          <section class="bridge-overview__stats">
            <article class="bridge-stat-card">
              <p class="bridge-stat-card__label">Pages</p>
              <strong>4</strong>
              <span>Overview, Building, L1 Bonus, L1/L2 Bonus</span>
            </article>
            <article class="bridge-stat-card">
              <p class="bridge-stat-card__label">Preview Types</p>
              <strong>3</strong>
              <span>Building flow, L1 bonus, L1/L2 bonus</span>
            </article>
            <article class="bridge-stat-card">
              <p class="bridge-stat-card__label">Customization</p>
              <strong>Live</strong>
              <span>Project pages update instantly as values change</span>
            </article>
            <article class="bridge-stat-card">
              <p class="bridge-stat-card__label">Collaboration</p>
              <strong>Active</strong>
              <span>Signed-in viewers and per-user page ordering persist</span>
            </article>
          </section>

          <section class="bridge-project-pages">
            <article class="bridge-page-card">
              <p class="bridge-page-card__eyebrow">Project pages</p>
              <h2>Navigate the prototype</h2>
              <p>Open any preview page directly or reorder the preview pages in the left nav for your preferred flow.</p>
              <a class="bridge-project-link" href="./building-preview.html">Open Building</a>
            </article>
          </section>
      <aside class="comments-panel" data-comments-root></aside>
        </main>
      </section>
    </div>

    <script src="./auth-gate.js"><\/script>
    <script src="./action-rail-icons.js"><\/script>
    <script src="./comments-panel.js"><\/script>
    <script src="./viewer-presence.js"><\/script>
  </body>
</html>
`,v=`<!DOCTYPE html>
<html lang="en" style="visibility: hidden">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>UX Bridge | Brand Affiliate Building</title>
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link
      href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap"
  ...
  <body
    class="bridge-body bridge-body--project"
    data-project-key="brand-affiliate-mobile"
    data-page-key="building"
    data-page-label="Building overview"
  >
    <div class="bridge-layout bridge-layout--project" data-bridge-shell hidden>
      <aside class="bridge-sidebar" data-bridge-sidebar>
        <a class="bridge-sidebar__brand" href="./projects.html" data-home-link="true" aria-label="UX Bridge home">
        ...
        <nav class="bridge-sidebar__nav" aria-label="Project pages">
          <a class="bridge-sidebar__link" href="./project-overview.html" data-project-page-key="overview">
            <span class="bridge-sidebar__label">Project Overview</span>
          </a>
          <div class="bridge-sidebar__nav-divider" aria-hidden="true"></div>
          <p class="bridge-sidebar__project-label bridge-sidebar__nav-label">Pages</p>
          <div class="bridge-sidebar__nav-pages" data-project-nav-pages>
            <div class="bridge-sidebar__nav-item" data-project-page-item="building">
              <a class="bridge-sidebar__link is-active" href="./building-preview.html" data-project-page-key="building">
                <span class="bridge-sidebar__drag" draggable="true" aria-label="Reorder Building page" role="button" tabindex="0">
                  <svg viewBox="0 0 20 20" aria-hidden="true">
                    <circle cx="7" cy="6" r="1.2" />
                    <circle cx="13" cy="6" r="1.2" />
        ...
        <header class="bridge-project-toolbar">
          <div class="bridge-project-toolbar__heading">
            ...
            <div>
              ...
              <h1 data-static-project-page-title>Building overview</h1>
            </div>
          </div>
          <div class="preview-scale-bar preview-scale-bar--header">
            <div class="preview-scale-select" data-preview-scale>
              <span class="sr-only">Preview scale</span>
              <button
                class="preview-scale-trigger"
                type="button"
                data-preview-scale-trigger
                aria-label="Preview scale"
                aria-haspopup="menu"
                aria-expanded="false"
              >
                <span class="preview-scale-trigger__icon" aria-hidden="true"></span>
                <span class="preview-scale-select__label" data-preview-scale-label>Fit</span>
                <span class="preview-scale-trigger__chevron" aria-hidden="true"></span>
              </button>
              <div class="preview-scale-menu" data-preview-scale-menu role="menu" hidden>
                <button type="button" class="preview-scale-menu__item" data-preview-scale-option="fit" role="menuitemradio" aria-checked="true">Fit</button>
                <button type="button" class="preview-scale-menu__item" data-preview-scale-option="0.25" role="menuitemradio" aria-checked="false">25%</button>
                <button type="button" class="preview-scale-menu__item" data-preview-scale-option="0.5" role="menuitemradio" aria-checked="false">50%</button>
                <button type="button" class="preview-scale-menu__item" data-preview-scale-option="0.75" role="menuitemradio" aria-checked="false">75%</button>
                <button type="button" class="preview-scale-menu__item" data-preview-scale-option="1" role="menuitemradio" aria-checked="false">Original (375x812)</button>
                <button type="button" class="preview-scale-menu__item" data-preview-scale-option="2" role="menuitemradio" aria-checked="false">200%</button>
              </div>
            </div>
          </div>
          <div class="bridge-project-toolbar__actions" data-header-actions></div>
      ...
      <div class="phone-frame-wrap">
        ...
        <header class="screen-top">
          <a class="brand-mark" href="./projects.html" data-home-link="true" aria-label="Go to UX Bridge home">
            <span class="brand-mark__icon" aria-hidden="true">
              <svg viewBox="0 0 32 32">
                <path d="M16 4C9.372 4 4 9.372 4 16c0 6.627 5.372 12 12 12 6.627 0 12-5.373 12-12C28 9.372 22.627 4 16 4Z" />
                <path d="M10.4 16c1.6-4.4 4.1-6.6 5.6-6.6s4 2.2 5.6 6.6c-1.6 4.4-4.1 6.6-5.6 6.6s-4-2.2-5.6-6.6Z" />
            ...
            <span class="brand-mark__label">BA</span>
          </a>
          <div class="screen-top__meta">
            <span class="screen-top__eyebrow">Dashboard</span>
            <h1>Brand Affiliate</h1>
          </div>
          <button class="icon-button" type="button" aria-label="Open section details">
            <svg viewBox="0 0 24 24" aria-hidden="true">
              <circle cx="12" cy="12" r="11" />
              <path d="M9 7.5L14 12L9 16.5" />
            </svg>
          </button>
        </header>
        ...
        <section class="section-card section-card--hero">
          <div class="eyebrow-row">
            <p class="eyebrow-row__label">Building</p>
            <p class="eyebrow-row__tag">Live mobile preview</p>
          </div>

          <div class="earnings-block">
            <p class="earnings-block__total">
              Estimated earnings:
              <span>$198</span>
            </p>
            <p class="earnings-block__copy">
              You’re currently earning <strong>8%</strong> on your <strong>L1+L2 SV</strong>
            </p>
          </div>
          ...
          <div class="ring-card">
            <div class="progress-ring" style="--progress: 75">
              <div class="progress-ring__inner">
                <span class="progress-ring__label">L1 SV</span>
                <strong>1,500</strong>
              </div>
            </div>
          </div>

          <div class="tiers-summary">
            <button class="summary-toggle" id="tiers-toggle" type="button" aria-expanded="false" aria-controls="bonus-tiers-panel">
              <span>Brand Affiliate Bonus Tiers</span>
              <svg viewBox="0 0 20 20" aria-hidden="true">
                <path d="M4 7.5L10 13.5L16 7.5" />
              </svg>
            </button>
            <div class="tier-pills" id="tier-pills" aria-label="Brand Affiliate bonus tiers"></div>
          </div>
        </section>

        <section class="section-card section-card--panel">
          <div class="section-heading">
            <div>
              <p class="section-heading__eyebrow">Bonus tiers</p>
              <h2>Projected earnings at each milestone</h2>
            </div>
          </div>

          <div class="bonus-tiers-panel" id="bonus-tiers-panel" hidden></div>
        </section>

        <section class="section-card section-card--panel">
          <div class="section-heading">
            <div>
              <p class="section-heading__eyebrow">Incentives</p>
              <h2>What unlocks next</h2>
            </div>
          </div>

          <div class="cards-stack" id="incentive-cards"></div>
        </section>
        </section>
      </div>
      <aside class="comments-panel" data-comments-root></aside>
    ...
    <script src="./auth-gate.js"><\/script>
    <script src="./capture-mode.js"><\/script>
    <script src="./viewport-scale.js"><\/script>
    <script src="./action-rail-icons.js"><\/script>
    <script src="./comments-panel.js"><\/script>
    <script src="./viewer-presence.js"><\/script>
    <script type="module" src="./building-preview.js"><\/script>
  </body>
</html>
`,y=`<!DOCTYPE html>
<html lang="en" style="visibility: hidden">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>UX Bridge | L1 Bonus</title>
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link
      href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap"
  ...
  <body
    ...
    class="bridge-body bridge-body--project"
    data-project-key="brand-affiliate-mobile"
    data-page-key="l1-bonus"
    data-page-label="L1 Bonus preview"
  >
    <div class="bridge-layout bridge-layout--project" data-bridge-shell hidden>
      <aside class="bridge-sidebar" data-bridge-sidebar>
        <a class="bridge-sidebar__brand" href="./projects.html" data-home-link="true" aria-label="UX Bridge home">
        ...
        <nav class="bridge-sidebar__nav" aria-label="Project pages">
          ...
          <div class="bridge-sidebar__nav-pages" data-project-nav-pages>
            ...
            <div class="bridge-sidebar__nav-item" data-project-page-item="l1-bonus">
              <a class="bridge-sidebar__link is-active" href="./l1-bonus-preview.html" data-project-page-key="l1-bonus">
                <span class="bridge-sidebar__drag" draggable="true" aria-label="Reorder L1 Bonus page" role="button" tabindex="0">
                  <svg viewBox="0 0 20 20" aria-hidden="true">
                    <circle cx="7" cy="6" r="1.2" />
                    <circle cx="13" cy="6" r="1.2" />
        ...
        <header class="bridge-project-toolbar">
          <div class="bridge-project-toolbar__heading">
            ...
            <div>
              ...
              <h1 data-static-project-page-title>L1 Bonus preview</h1>
            </div>
          </div>
          <div class="preview-scale-bar preview-scale-bar--header">
            <div class="preview-scale-select" data-preview-scale>
      ...
      <div class="phone-frame-wrap">
        <section class="phone-frame">
          <section class="mobile-page">
            ...
            <div class="device-topbar__status">
              <span>9:41</span>
              <div class="device-topbar__icons" aria-hidden="true">
                <span class="device-dot"></span>
                <span class="device-pill"></span>
                <span class="device-battery"></span>
              </div>
            </div>

            <div class="device-topbar__nav">
              <a class="brand-mark brand-mark--solo" href="./projects.html" data-home-link="true" aria-label="Go to UX Bridge home">
                <span class="brand-mark__icon" aria-hidden="true">
                  <svg viewBox="0 0 32 32">
                    <path d="M16 4C9.372 4 4 9.372 4 16c0 6.627 5.372 12 12 12 6.627 0 12-5.373 12-12C28 9.372 22.627 4 16 4Z" />
                    <path d="M10.4 16c1.6-4.4 4.1-6.6 5.6-6.6s4 2.2 5.6 6.6c-1.6 4.4-4.1 6.6-5.6 6.6s-4-2.2-5.6-6.6Z" />
              ...
              <div class="device-topbar__actions" aria-hidden="true">
                <span>LT</span>
                <span>VS</span>
                <svg viewBox="0 0 24 24">
                  <path d="M12 4a6 6 0 0 0-6 6v3.4l-1.2 2.4A1 1 0 0 0 5.7 17h12.6a1 1 0 0 0 .9-1.2L18 13.4V10a6 6 0 0 0-6-6Z" />
                ...
                <svg viewBox="0 0 24 24">
                  <path d="M10 7 15 12 10 17" />
                  <path d="M4 4v16" />
                </svg>
              </div>
            </div>

            <div class="device-topbar__controls">
            ...
            <section class="mobile-section-card">
              <div class="eyebrow-row">
                <p class="eyebrow-row__label">Bonuses</p>
              </div>

              <div class="l1-content">
                <div
                  class="estimated-earnings"
                  data-section-key="estimated-earnings"
                  role="button"
                  tabindex="0"
                  aria-expanded="false"
                  data-money-collapsed="https://www.figma.com/api/mcp/asset/904bba46-69c7-445b-be1c-87ec2e8099f7"
                  data-money-expanded="https://www.figma.com/api/mcp/asset/02f952ca-6b23-473e-add4-8f317480c5d3"
                >
                  <div class="estimated-earnings__summary">
                    <div class="estimated-earnings__headline">
                      <div class="estimated-earnings__top">
                        <p class="estimated-earnings__eyebrow">Total Estimated Earnings</p>
                      </div>
                      <div class="estimated-earnings__collapsed">
                        <p class="estimated-earnings__amount">$100.50</p>
                        <img
                          class="estimated-earnings__money-icon"
                          src="https://www.figma.com/api/mcp/asset/904bba46-69c7-445b-be1c-87ec2e8099f7"
                          alt=""
                        />
                      </div>
                    </div>
                    <div class="estimated-earnings__expand" aria-hidden="true">
                      <span class="estimated-earnings__expand-label">Earnings Breakdown</span>
                      <span class="estimated-earnings__expand-chevron">
                  ...
                  <div class="estimated-earnings__body">
                    <div class="estimated-earnings__divider" aria-hidden="true"></div>
                    <div class="estimated-earnings__breakdown">
                      <div class="estimated-earnings__row">
                        <span>Retailing Bonus</span>
                        <strong>$34</strong>
                      </div>
                      <div class="estimated-earnings__row estimated-earnings__row--stacked">
                        <div>
                          <span class="bridge-sidebar__label">L1 Bonus</span>
                          <small>5% of the CSV</small>
                        </div>
                        <strong>$67</strong>
                      </div>
                    </div>
                ...
                <section class="content-block" data-section-key="incentives">
                  <div class="content-block__heading">
                    <h2>Up Next</h2>
                    <a href="./building-preview.html">View All</a>
                  </div>

                  <div class="up-next-carousel" data-up-next-carousel></div>
                </section>

                <section class="content-block" data-section-key="bonus-breakdown">
                  <div class="content-block__heading content-block__heading--stacked">
                  ...
                  <article class="bonus-card">
                    <div class="bonus-card__header">
                      <div>
                        <p class="bonus-card__title">L1 Bonus</p>
                        <p class="bonus-card__amount">$0.00</p>
                      </div>
                      <span class="bonus-card__chevron" aria-hidden="true">
                    ...
                    <div class="bonus-card__rows">
                      <div class="bonus-row">
                        <div class="bonus-row__left">
                          <span class="bonus-row__label">Level 1</span>
                          <span class="bonus-badge">5%</span>
                        </div>
                        <span class="bonus-row__value">520 SV</span>
                      </div>
                    </div>
                  </article>
                </section>
      ...
      <aside class="comments-panel" data-comments-root></aside>
      <aside class="customizer-panel" data-customizer-root></aside>
        </main>
      </section>
    </div>
    ...
    <script src="./estimated-earnings.js"><\/script>
    <script src="./incentive-carousel.js"><\/script>
  </body>
</html>
`,b=`<!DOCTYPE html>
<html lang="en" style="visibility: hidden">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>UX Bridge | L1/L2 Bonus</title>
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link
      href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap"
  ...
  <body
    ...
    class="bridge-body bridge-body--project"
    data-project-key="brand-affiliate-mobile"
    data-page-key="l1-l2-bonus"
    data-page-label="L1/L2 Bonus preview"
  >
    <div class="bridge-layout bridge-layout--project" data-bridge-shell hidden>
      <aside class="bridge-sidebar" data-bridge-sidebar>
        <a class="bridge-sidebar__brand" href="./projects.html" data-home-link="true" aria-label="UX Bridge home">
        ...
        <nav class="bridge-sidebar__nav" aria-label="Project pages">
          ...
          <div class="bridge-sidebar__nav-pages" data-project-nav-pages>
            ...
            <div class="bridge-sidebar__nav-item" data-project-page-item="l1-l2-bonus">
              <a class="bridge-sidebar__link is-active" href="./l1-l2-bonus-preview.html" data-project-page-key="l1-l2-bonus">
                <span class="bridge-sidebar__drag" draggable="true" aria-label="Reorder L1/L2 Bonus page" role="button" tabindex="0">
                  <svg viewBox="0 0 20 20" aria-hidden="true">
                    <circle cx="7" cy="6" r="1.2" />
                    <circle cx="13" cy="6" r="1.2" />
        ...
        <header class="bridge-project-toolbar">
          <div class="bridge-project-toolbar__heading">
            ...
            <div>
              ...
              <h1 data-static-project-page-title>L1/L2 Bonus preview</h1>
            </div>
          </div>
          <div class="preview-scale-bar preview-scale-bar--header">
            <div class="preview-scale-select" data-preview-scale>
            ...
            <section class="mobile-section-card">
              ...
              <div class="l1-content">
                <div
                  ...
                  tabindex="0"
                  aria-expanded="false"
                  data-money-collapsed="https://www.figma.com/api/mcp/asset/e35e4d63-a8c6-4f34-a0bb-426fe50f1581"
                  data-money-expanded="https://www.figma.com/api/mcp/asset/4db4f726-a37c-4a75-af62-95db3bf7e217"
                >
                  <div class="estimated-earnings__summary">
                    <div class="estimated-earnings__headline">
                      <div class="estimated-earnings__top">
                      ...
                      <div class="estimated-earnings__collapsed">
                        <p class="estimated-earnings__amount">$177.32</p>
                        <img
                          class="estimated-earnings__money-icon"
                          src="https://www.figma.com/api/mcp/asset/e35e4d63-a8c6-4f34-a0bb-426fe50f1581"
                          alt=""
                        />
                      </div>
                    </div>
                ...
                <section class="content-block" data-section-key="bonus-breakdown">
                  ...
                  <article class="bonus-card">
                    <div class="bonus-card__header">
                      <div>
                        <p class="bonus-card__title">L1/L2 Bonus</p>
                        <p class="bonus-card__amount">$0.00</p>
                      </div>
                      <span class="bonus-card__chevron" aria-hidden="true">
                        <svg viewBox="0 0 20 20">
                    ...
                    <div class="bonus-card__rows bonus-card__rows--dual">
                      <div class="bonus-row">
                        <div class="bonus-row__left">
                          <span class="bonus-row__label">Level 1</span>
                          <span class="bonus-badge">5%</span>
                      ...
                      <div class="bonus-row">
                        <div class="bonus-row__left">
                          <span class="bonus-row__label">Level 2</span>
                          <span class="bonus-badge">5%</span>
                        </div>
                        <span class="bonus-row__value">50 SV</span>
                      </div>
                    </div>
                  </article>
                </section>
...
<html lang="en" style="visibility: hidden">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>UX Bridge | Project Page</title>
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link
      href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap"
  ...
  <body class="bridge-body bridge-body--project" data-dynamic-project="true">
    <div class="bridge-layout bridge-layout--project" data-bridge-shell hidden>
      <section class="bridge-main bridge-main--project">
        <header class="bridge-project-toolbar">
          <div class="bridge-project-toolbar__heading">
            <div>
              <p class="bridge-back-link">
                <a href="./projects.html" data-project-back-link>
                  <svg viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div class="bridge-project-page-title" data-page-title-shell>
                <h1 data-project-page-title>Project</h1>
                <button
                  class="bridge-inline-edit-trigger bridge-project-page-title__edit"
                  type="button"
                ...
                <div class="bridge-project-page-title__editor" data-page-title-editor hidden>
                  <textarea
                    class="bridge-project-page-title__input"
                    rows="1"
                    aria-label="Project name"
                    data-project-title-input
                  ></textarea>
                  <button
                    class="bridge-project-page-title__save"
                    type="button"
                    aria-label="Save project name"
                    data-save-project-name
                  >
                    <svg viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div class="bridge-project-toolbar__actions" data-header-actions>
            <div class="preview-scale-bar preview-scale-bar--header">
              <div class="preview-scale-select" data-preview-scale>
                <span class="sr-only">Preview scale</span>
                <button
                  ...
                  data-preview-scale-trigger
                  aria-label="Preview scale"
                  data-tooltip="Screen Size"
                  aria-haspopup="menu"
                  aria-expanded="false"
                >
                  <span class="preview-scale-trigger__icon" aria-hidden="true"></span>
                  <span class="preview-scale-trigger__copy">
                    <span class="preview-scale-select__label" data-preview-scale-label>Fit</span>
                    <span class="preview-scale-select__subtext" data-preview-scale-subtext hidden></span>
                  </span>
                </button>
                <div class="preview-scale-menu" data-preview-scale-menu role="menu" hidden>
                  <div class="preview-scale-menu__section">
                    <div class="preview-scale-menu__viewport-row" data-preview-viewport-menu role="group" aria-label="Preview screen size">
                      <button type="button" class="preview-scale-menu__viewport-option" data-preview-viewport-option="mobile" aria-pressed="true">
                        <span class="preview-scale-menu__viewport-icon preview-scale-menu__viewport-icon--mobile" aria-hidden="true"></span>
                        <span class="preview-scale-menu__viewport-copy">
                          <span class="preview-scale-menu__viewport-label">Mobile</span>
                          <span class="preview-scale-menu__viewport-note">375 × 812</span>
                        </span>
                      </button>
                      <button type="button" class="preview-scale-menu__viewport-option" data-preview-viewport-option="tablet-portrait" aria-pressed="false">
                        <span class="preview-scale-menu__viewport-icon preview-scale-menu__viewport-icon--tablet-portrait" aria-hidden="true"></span>
                        <span class="preview-scale-menu__viewport-copy">
                          <span class="preview-scale-menu__viewport-label">Tablet</span>
                          <span class="preview-scale-menu__viewport-note">768 × 1024</span>
                        </span>
                      </button>
                      <button type="button" class="preview-scale-menu__viewport-option" data-preview-viewport-option="tablet-landscape" aria-pressed="false">
                        <span class="preview-scale-menu__viewport-icon preview-scale-menu__viewport-icon--tablet-landscape" aria-hidden="true"></span>
                        <span class="preview-scale-menu__viewport-copy">
                          <span class="preview-scale-menu__viewport-label">Wide</span>
                          <span class="preview-scale-menu__viewport-note">1024 × 768</span>
                        </span>
                      </button>
                      <button type="button" class="preview-scale-menu__viewport-option" data-preview-viewport-option="desktop" aria-pressed="false">
                        <span class="preview-scale-menu__viewport-icon preview-scale-menu__viewport-icon--desktop" aria-hidden="true"></span>
                        <span class="preview-scale-menu__viewport-copy">
                          <span class="preview-scale-menu__viewport-label">Desktop</span>
                          <span class="preview-scale-menu__viewport-note">1440 × 1024</span>
                        </span>
                      </button>
                      <button type="button" class="preview-scale-menu__viewport-option" data-preview-viewport-option="responsive" aria-pressed="false">
                        <span class="preview-scale-menu__viewport-icon preview-scale-menu__viewport-icon--responsive" aria-hidden="true"></span>
                        <span class="preview-scale-menu__viewport-copy">
                          <span class="preview-scale-menu__viewport-label">Responsive</span>
                          <span class="preview-scale-menu__viewport-note">Fluid layout</span>
                        </span>
                      </button>
                    </div>
                  </div>
                  <div class="preview-scale-menu__section preview-scale-menu__section--scales">
                    <button type="button" class="preview-scale-menu__item preview-scale-menu__item--shortcut" data-preview-scale-option="fit" data-preview-scale-trigger-label="Fit" role="menuitemradio" aria-checked="true">
                      <span class="preview-scale-menu__item-label">Fit</span>
                      <span class="preview-scale-menu__item-meta">
                        <span class="preview-scale-menu__item-shortcut">Cmd + 1</span>
                      </span>
                    </button>
                    <button type="button" class="preview-scale-menu__item" data-preview-scale-option="0.25" role="menuitemradio" aria-checked="false" hidden>25%</button>
                    <button type="button" class="preview-scale-menu__item" data-preview-scale-option="0.5" role="menuitemradio" aria-checked="false" hidden>50%</button>
                    <button type="button" class="preview-scale-menu__item" data-preview-scale-option="0.75" role="menuitemradio" aria-checked="false" hidden>75%</button>
                    <button type="button" class="preview-scale-menu__item preview-scale-menu__item--shortcut preview-scale-menu__item--stacked" data-preview-scale-option="1" data-preview-scale-trigger-label="Actual" data-preview-scale-trigger-subtext="(375x812)" role="menuitemradio" aria-checked="false">
                      <span class="preview-scale-menu__item-copy">
                        <span class="preview-scale-menu__item-label">Actual</span>
                        <span class="preview-scale-menu__item-note">(375x812)</span>
                      </span>
                      <span class="preview-scale-menu__item-meta">
                        <span class="preview-scale-menu__item-shortcut">Cmd + 0</span>
                      </span>
                    </button>
                    <button type="button" class="preview-scale-menu__item" data-preview-scale-option="2" role="menuitemradio" aria-checked="false">200%</button>
                  </div>
        ...
        <main class="app-shell">
          <nav class="project-page-strip" data-project-page-strip aria-label="Project pages">
            <div class="project-page-strip__footer" data-project-nav-footer hidden></div>
            <div class="project-page-strip__pages" data-project-nav-pages></div>
          </nav>
          <div class="bridge-preview-shell">
            <div class="bridge-project-side-actions">
              <div class="bridge-project-side-actions__primary" data-side-actions></div>
            </div>
            <div class="phone-frame-wrap" data-preview-ready="false">
              <div class="preview-layer-tools" data-preview-layer-tools hidden>
                <div class="preview-layer-tools__bar">
                  <button
                    type="button"
                    class="preview-layer-tools__button preview-layer-tools__button--reset"
                    data-preview-layer-reset
                    aria-label="Reset breakpoint changes for selected layer"
                  ...
                  <button
                    type="button"
                    class="preview-layer-tools__button"
                    data-preview-layer-tool="ai"
                    aria-label="Vibe for selected layer"
                    data-tooltip="Vibe"
                  >
                    <svg viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  <button
                    type="button"
                    class="preview-layer-tools__button"
                    data-preview-layer-tool="comment"
                    aria-label="Comment on selected layer"
                    data-tooltip="Comment"
                  >
                    <svg viewBox="0 0 24 24" aria-hidden="true">
                      <path d="M5 6.5c0-1.38 1.12-2.5 2.5-2.5h9c1.38 0 2.5 1.12 2.5 2.5v7c0 1.38-1.12 2.5-2.5 2.5H10l-4.5 4v-4H7.5C6.12 16 5 14.88 5 13.5Z"></path>
                      <path d="M8 8.75h8"></path>
                      <path d="M8 12h5.5"></path>
                    </svg>
                  </button>
                  <button
                    type="button"
                    class="preview-layer-tools__button"
                    data-preview-layer-tool="link"
                    aria-label="Link selected layer to another page"
                    data-tooltip="Link"
                  >
                    <svg viewBox="0 0 24 24" aria-hidden="true">
                      <path d="M10.5 13.5 13.5 10.5"></path>
                      <path d="M7.7 15.3 5.2 17.8a3 3 0 0 0 4.24 4.24l2.5-2.5"></path>
                      <path d="M16.3 8.7l2.5-2.5a3 3 0 1 0-4.24-4.24l-2.5 2.5"></path>
                    </svg>
                  </button>
                </div>
                <div class="preview-layer-tools__popover" data-preview-layer-tools-popover hidden></div>
              </div>
              <section class="phone-frame">
                <section class="mobile-page mobile-page--empty">
                <header class="empty-mobile-taskbar" aria-hidden="true">
                  <span class="empty-mobile-taskbar__time">9:41</span>
                  <span class="empty-mobile-taskbar__sensor"></span>
                  <div class="empty-mobile-taskbar__status">
                    <span class="empty-mobile-taskbar__signal" aria-hidden="true">
                      <span></span>
                      <span></span>
                      <span></span>
                      <span></span>
                    </span>
                    <span class="empty-mobile-taskbar__wifi" aria-hidden="true">
                      <svg viewBox="0 0 16 12" aria-hidden="true">
                        <path d="M1.5 4.2C5.27 0.93 10.73 0.93 14.5 4.2" />
                        <path d="M3.95 6.65C6.28 4.64 9.72 4.64 12.05 6.65" />
                        <path d="M6.2 8.9C7.27 7.98 8.73 7.98 9.8 8.9" />
                        <circle cx="8" cy="10.3" r="1.05" />
                      </svg>
                    </span>
                    <span class="empty-mobile-taskbar__battery" aria-hidden="true">
                      <span class="empty-mobile-taskbar__battery-level"></span>
                    </span>
                  </div>
                </header>
                <header class="desktop-preview-windowbar" aria-hidden="true">
                  <div class="desktop-preview-windowbar__traffic">
                    <span class="desktop-preview-windowbar__dot desktop-preview-windowbar__dot--close"></span>
                    <span class="desktop-preview-windowbar__dot desktop-preview-windowbar__dot--minimize"></span>
                    <span class="desktop-preview-windowbar__dot desktop-preview-windowbar__dot--zoom"></span>
                  </div>
                  <div class="desktop-preview-windowbar__address">
                    <span class="desktop-preview-windowbar__lock" aria-hidden="true">
                      <svg viewBox="0 0 16 16">
                        <rect x="3.5" y="7" width="9" height="6" rx="1.75"></rect>
                        <path d="M5.5 7V5.75A2.5 2.5 0 0 1 8 3.25a2.5 2.5 0 0 1 2.5 2.5V7"></path>
                      </svg>
                    </span>
                    <span>uxbridge.io</span>
                  </div>
                  <div class="desktop-preview-windowbar__actions">
                    <span class="desktop-preview-windowbar__action"></span>
                    <span class="desktop-preview-windowbar__action"></span>
                  </div>
                </header>

                <section class="empty-mobile-shell" data-empty-mobile-shell>
                  <p class="empty-mobile-shell__eyebrow">Empty mobile shell</p>
                  <h2 data-empty-shell-page-title>Page</h2>
                  <p>Choose a vibe-coding tool to start designing this page inside the mobile preview.</p>
                  <div class="empty-mobile-shell__actions">
                    <p class="empty-mobile-shell__actions-title">Design with:</p>
                    <div class="empty-mobile-shell__design-options">
                      <button type="button" class="empty-mobile-shell__choice" data-vibe-launch-provider="codex" aria-label="Design with Codex">
                        <span class="empty-mobile-shell__choice-icon empty-mobile-shell__choice-icon--codex" aria-hidden="true">
                          <svg viewBox="0 0 24 24">
                            <path d="M9.2 3.6 6.1 5.4a4.6 4.6 0 0 0-2.3 4v3.3a4.6 4.6 0 0 0 2.3 4l3.1 1.8m5-14.9 3.1 1.8a4.6 4.6 0 0 1 2.3 4v3.3a4.6 4.6 0 0 1-2.3 4l-3.1 1.8m-5 0 5-2.9m-5-8.2 5 2.9m-5 5.3V6.5" />
                          </svg>
                        </span>
                        <span class="empty-mobile-shell__choice-label">Codex</span>
                      </button>
                      <button type="button" class="empty-mobile-shell__choice" data-vibe-launch-provider="claude" aria-label="Design with Claude">
                        <span class="empty-mobile-shell__choice-icon empty-mobile-shell__choice-icon--claude" aria-hidden="true">
                          <svg viewBox="0 0 24 24">
                            <path d="M5.5 6.5h6.8v3.1H8.7v1.6h3.1v3H8.7v3.3H5.5Zm8.2 0h2.9c2.8 0 4.9 1.9 4.9 5.2s-2.1 5.3-4.9 5.3h-2.9Z" />
                          </svg>
                        </span>
                ...
                <section class="vibe-mobile-stage" data-vibe-mobile-stage hidden>
                  <style data-vibe-mobile-style></style>
                  <div class="vibe-mobile-stage__render" data-vibe-mobile-render></div>
                </section>
              </section>
            </section>
            </div>
            <div class="bridge-preview-header">
              <div class="bridge-preview-page-title" data-preview-page-title-shell>
                <p class="bridge-preview-page-name" data-preview-page-name>Page</p>
                <button
                  class="bridge-inline-edit-trigger bridge-preview-page-title__edit"
                  type="button"
                ...
                <div class="bridge-preview-page-title__editor" data-preview-page-title-editor hidden>
                  <input
                    class="bridge-preview-page-title__input"
                    type="text"
                    aria-label="Page name"
                    data-preview-page-title-input
                  />
                  <button
                    class="bridge-preview-page-title__save"
                    type="button"
              ...
              <div class="bridge-preview-header__actions">
                <button
                  type="button"
                  class="preview-refresh-button preview-refresh-button--preview-header"
                ...
                >
                  <svg viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M20 6v5h-5" />
                    <path d="M4 18v-5h5" />
                    <path d="M7.7 8.2A7 7 0 0 1 20 11" />
                    <path d="M16.3 15.8A7 7 0 0 1 4 13" />
                  </svg>
                </button>
                <button
                  type="button"
                  class="preview-refresh-button preview-refresh-button--preview-header preview-refresh-button--danger"
                  data-preview-delete-empty-page
                  aria-label="Delete empty page"
                  data-tooltip="Delete"
                  hidden
                >
                  <svg viewBox="0 0 24 24" aria-hidden="true">
                ...
                <button
                  type="button"
                  class="preview-refresh-button preview-refresh-button--preview-header preview-refresh-button--menu"
                  data-preview-page-menu-toggle
        ...
        <aside class="inspector-panel" data-preview-inspector hidden>
          <div class="inspector-panel__inner">
            <div class="preview-inspector__content" data-preview-inspector-content></div>
          </div>
        </aside>
        <aside class="vibe-panel" data-vibe-root></aside>
        <aside class="comments-panel" data-comments-root></aside>
        <div class="preview-page-menu" data-preview-page-menu role="menu" aria-label="Page options" hidden>
          <button type="button" class="preview-page-menu__item" data-preview-page-action="duplicate" role="menuitem">
            <span class="preview-page-menu__label">Duplicate</span>
          </button>
          <button type="button" class="preview-page-menu__item" data-preview-page-action="clear" role="menuitem">
            <span class="preview-page-menu__label">Clear</span>
          </button>
          <button type="button" class="preview-page-menu__item preview-page-menu__item--danger" data-preview-page-action="delete" role="menuitem">
            <span class="preview-page-menu__label">Delete</span>
          </button>
        </div>
      </section>
    </div>
    ...
    <script src="./capture-mode.js"><\/script>
    <script src="./viewport-scale.js"><\/script>
    <script src="./project-page-runtime.js"><\/script>
    <script src="./action-rail-icons.js"><\/script>
    <script src="./vibe-drawer.js"><\/script>
    <script src="./comments-panel.js"><\/script>
    <script src="./viewer-presence.js"><\/script>
  </body>
</html>
`;function S(e,t){let n=new DOMParser().parseFromString(e,`text/html`).querySelector(t);return n?n.outerHTML:``}var ee=S(f,`main.auth-layout`),C=S(p,`div[data-bridge-shell]`),te=S(m,`div[data-bridge-shell]`),ne=S(h,`div[data-bridge-shell]`),re=S(g,`main.auth-layout`),ie=S(_,`div[data-bridge-shell]`),ae=S(v,`div[data-bridge-shell]`),oe=S(y,`div[data-bridge-shell]`),se=S(b,`div[data-bridge-shell]`),ce=S(x,`div[data-bridge-shell]`);function le({title:e,bodyClass:t=``,bodyDataset:n={},scriptLoaders:r=[]}){(0,u.useLayoutEffect)(()=>{document.title=e;let i=t.includes(`bridge-body--project`),a=n.dynamicProject===`true`,o=window.location.pathname===`/project-overview.html`,s=(window.visualViewport?.width||window.innerWidth)>=641,c=(()=>{try{return window.sessionStorage.getItem(`ux-bridge-project-nav-open`)===`true`}catch{return!1}})(),l=(()=>{try{return!!window.sessionStorage.getItem(`ux-bridge-user`)}catch{return!1}})(),u=!window.__uxBridgePageBooted&&!l;if(t.includes(`bridge-body--project`)){let e=document.querySelector(`.bridge-main--project`),t=document.querySelector(`.bridge-project-toolbar`),n=document.querySelector(`.app-shell`),r=window.visualViewport?.width||window.innerWidth,i=window.visualViewport?.height||window.innerHeight,a=e?window.getComputedStyle(e):null,o=n?window.getComputedStyle(n):null,s=t?window.getComputedStyle(t):null,c=a&&Number.parseFloat(a.paddingTop)||0,l=a&&Number.parseFloat(a.paddingBottom)||0,u=a&&Number.parseFloat(a.paddingLeft)||0,d=a&&Number.parseFloat(a.paddingRight)||0,f=o&&Number.parseFloat(o.paddingTop)||0,p=o&&Number.parseFloat(o.paddingBottom)||0,m=o&&Number.parseFloat(o.paddingLeft)||0,h=o&&Number.parseFloat(o.paddingRight)||0,g=t?t.getBoundingClientRect().height:0,_=s&&Number.parseFloat(s.marginBottom)||0,v=Math.max(e?i-c-l-g-_-f-p:window.innerHeight-40,0),y=Math.max(e?r-u-d-m-h:window.innerWidth-28,0),b=Math.min(v/812,y/375);document.documentElement.style.setProperty(`--phone-scale`,String(b))}u?document.documentElement.style.visibility=`hidden`:document.documentElement.style.visibility=`visible`;let d=t.split(/\s+/).filter(Boolean),f=o?c:s;if(i&&f&&d.push(`bridge-nav-open`),i&&f&&d.push(`bridge-nav-restoring`),document.body.className=d.join(` `),i&&!a)try{let e=window.sessionStorage.getItem(`ux-bridge-project-nav-order:brand-affiliate-mobile`);if(e){let t=document.querySelector(`[data-project-nav-pages]`);if(t){let n=Array.from(t.querySelectorAll(`[data-project-page-item]`)),r=new Map(n.map(e=>[e.dataset.projectPageItem,e])),i=n.map(e=>e.dataset.projectPageItem).filter(Boolean),a=JSON.parse(e),o=Array.isArray(a)?a.filter((e,t)=>i.includes(e)&&a.indexOf(e)===t):[];[...o,...i.filter(e=>!o.includes(e))].forEach(e=>{let n=r.get(e);n&&t.append(n)})}}}catch{}Object.keys(document.body.dataset).forEach(e=>{delete document.body.dataset[e]}),Object.entries(n).forEach(([e,t])=>{t!=null&&(document.body.dataset[e]=t)});let p=!1;return(async()=>{for(let e of r){if(p)return;await e()}p||(window.__uxBridgePageBooted=!0,document.documentElement.style.visibility=`visible`)})(),()=>{p=!0}},[e,t,n,r])}var ue=t((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),w=t(((e,t)=>{t.exports=ue()}))(),T=`modulepreload`,E=function(e){return`/`+e},de={},D=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=E(t,n),t in de)return;de[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:T,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})};function fe({html:e}){return(0,w.jsx)(`div`,{style:{display:`contents`},dangerouslySetInnerHTML:{__html:e}})}function pe({to:e}){return(0,u.useEffect)(()=>{window.location.replace(e)},[e]),null}function O(){return le({title:`Sign In | UX Bridge`,bodyClass:`auth-page`,scriptLoaders:(0,u.useMemo)(()=>[()=>D(()=>import(`./auth-page-QImOe3Rf.js`),[])],[])}),(0,w.jsx)(fe,{html:ee})}function k(){return le({title:`Reset Password | UX Bridge`,bodyClass:`auth-page`,scriptLoaders:(0,u.useMemo)(()=>[()=>D(()=>import(`./reset-password-kt03o3L7.js`),[])],[])}),(0,w.jsx)(fe,{html:re})}function me(){return le({title:`UX Bridge`,bodyClass:`bridge-body`,scriptLoaders:(0,u.useMemo)(()=>[()=>D(()=>import(`./auth-gate-ZAAry9XD.js`),[]),()=>D(()=>import(`./projects-home-BR3vKtcc.js`),[])],[])}),(0,w.jsx)(fe,{html:C})}function he(){return le({title:`UX Bridge | Admin`,bodyClass:`bridge-body`,bodyDataset:{adminPage:`true`},scriptLoaders:(0,u.useMemo)(()=>[()=>D(()=>import(`./auth-gate-ZAAry9XD.js`),[]),()=>D(()=>import(`./admin-users-BRNB6KtL.js`),[])],[])}),(0,w.jsx)(fe,{html:te})}function ge(){return le({title:`UX Bridge | Profile`,bodyClass:`bridge-body`,bodyDataset:{profilePage:`true`},scriptLoaders:(0,u.useMemo)(()=>[()=>D(()=>import(`./auth-gate-ZAAry9XD.js`),[]),()=>D(()=>import(`./profile-page-U_gby4Hr.js`),[])],[])}),(0,w.jsx)(fe,{html:ne})}function _e(){return le({title:`UX Bridge | Brand Affiliate Overview`,bodyClass:`bridge-body bridge-body--project bridge-body--overview`,scriptLoaders:(0,u.useMemo)(()=>[()=>D(()=>import(`./auth-gate-ZAAry9XD.js`),[]),()=>D(()=>import(`./thumbnail-capture-cch4re1k.js`),__vite__mapDeps([0,1])),()=>D(()=>import(`./project-share-B6hDl_7b.js`),[]),()=>D(()=>import(`./comments-panel-scoped-comments.js`),[])],[])}),(0,w.jsx)(fe,{html:ie})}function ve(){return le({title:`UX Bridge | Brand Affiliate Building`,bodyClass:`bridge-body bridge-body--project`,scriptLoaders:(0,u.useMemo)(()=>[()=>D(()=>import(`./auth-gate-ZAAry9XD.js`),[]),()=>D(()=>import(`./thumbnail-capture-cch4re1k.js`),__vite__mapDeps([0,1])),()=>D(()=>import(`./project-share-B6hDl_7b.js`),[]),()=>D(()=>import(`./capture-mode-MkIeYGlg.js`),[]),()=>D(()=>import(`./viewport-scale-BJpRoV2E.js`),[]),()=>D(()=>import(`./comments-panel-scoped-comments.js`),[]),()=>D(()=>import(`./building-preview-BtBVDObt.js`),[])],[])}),(0,w.jsx)(fe,{html:ae})}function ye(){return le({title:`UX Bridge | L1 Bonus`,bodyClass:`bridge-body bridge-body--project`,bodyDataset:{page:`l1`},scriptLoaders:(0,u.useMemo)(()=>[()=>D(()=>import(`./auth-gate-ZAAry9XD.js`),[]),()=>D(()=>import(`./thumbnail-capture-cch4re1k.js`),__vite__mapDeps([0,1])),()=>D(()=>import(`./project-share-B6hDl_7b.js`),[]),()=>D(()=>import(`./capture-mode-MkIeYGlg.js`),[]),()=>D(()=>import(`./viewport-scale-BJpRoV2E.js`),[]),()=>D(()=>import(`./comments-panel-scoped-comments.js`),[]),()=>D(()=>import(`./customizer-D6C_jzW9.js`),[]),()=>D(()=>import(`./estimated-earnings-_CeoWfNU.js`),[]),()=>D(()=>import(`./incentive-carousel-C8_2K_FN.js`),[])],[])}),(0,w.jsx)(fe,{html:oe})}function be(){return le({title:`UX Bridge | L1/L2 Bonus`,bodyClass:`bridge-body bridge-body--project`,bodyDataset:{page:`l1l2`},scriptLoaders:(0,u.useMemo)(()=>[()=>D(()=>import(`./auth-gate-ZAAry9XD.js`),[]),()=>D(()=>import(`./thumbnail-capture-cch4re1k.js`),__vite__mapDeps([0,1])),()=>D(()=>import(`./project-share-B6hDl_7b.js`),[]),()=>D(()=>import(`./capture-mode-MkIeYGlg.js`),[]),()=>D(()=>import(`./viewport-scale-BJpRoV2E.js`),[]),()=>D(()=>import(`./comments-panel-scoped-comments.js`),[]),()=>D(()=>import(`./customizer-D6C_jzW9.js`),[]),()=>D(()=>import(`./estimated-earnings-_CeoWfNU.js`),[]),()=>D(()=>import(`./incentive-carousel-C8_2K_FN.js`),[])],[])}),(0,w.jsx)(fe,{html:se})}function xe(){return le({title:`UX Bridge | Project Page`,bodyClass:`bridge-body bridge-body--project`,bodyDataset:{dynamicProject:`true`},scriptLoaders:(0,u.useMemo)(()=>[()=>D(()=>import(`./auth-gate-ZAAry9XD.js`),[]),()=>D(()=>import(`./thumbnail-capture-cch4re1k.js`),__vite__mapDeps([0,1])),()=>D(()=>import(`./project-share-B6hDl_7b.js`),[]),()=>D(()=>import(`./capture-mode-MkIeYGlg.js`),[]),()=>D(()=>import(`./viewport-scale-BJpRoV2E.js`),[]),()=>D(()=>import(`./project-page-runtime-no-inspector-breadcrumbs.js`),__vite__mapDeps([2,3,1])),()=>D(()=>import(`./vibe-drawer-C6LasT6s.js`),[]),()=>D(()=>import(`./comments-panel-scoped-comments.js`),[]),()=>D(()=>import(`./dev-mode-drawer.js`),[]),()=>D(()=>import(`./customizer-D6C_jzW9.js`),[])],[])}),(0,w.jsx)(fe,{html:ce})}function Se(){return(0,u.useEffect)(()=>{document.title=`UX Bridge`,document.body.className=`bridge-body`,document.documentElement.style.visibility=`visible`},[]),(0,w.jsx)(`main`,{className:`auth-layout`,children:(0,w.jsxs)(`section`,{className:`auth-card`,children:[(0,w.jsxs)(`div`,{className:`auth-card__intro`,children:[(0,w.jsx)(`p`,{className:`auth-card__eyebrow`,children:`UX Bridge`}),(0,w.jsx)(`h1`,{children:`Page not found`}),(0,w.jsx)(`p`,{className:`auth-card__copy`,children:`The page you tried to open does not exist.`})]}),(0,w.jsx)(`a`,{className:`auth-submit`,href:`/index.html`,children:`Go to Sign In`})]})})}function Ce(){let e=window.location.pathname;return e===`/`||e===`/index.html`?(0,w.jsx)(O,{}):e===`/reset-password.html`?(0,w.jsx)(k,{}):e===`/home.html`?(0,w.jsx)(pe,{to:`/projects.html`}):e===`/projects.html`?(0,w.jsx)(me,{}):e===`/admin.html`?(0,w.jsx)(pe,{to:`/user-management.html`}):e===`/user-management.html`?(0,w.jsx)(he,{}):e===`/profile.html`?(0,w.jsx)(ge,{}):e===`/overview.html`?(0,w.jsx)(pe,{to:`/project-overview.html`}):e===`/project-overview.html`?(0,w.jsx)(_e,{}):e===`/brand-affiliate-mobile.html`||e===`/brand-affiliate-project.html`?(0,w.jsx)(pe,{to:`/project-overview.html`}):e===`/building.html`?(0,w.jsx)(pe,{to:`/building-preview.html`}):e===`/building-preview.html`?(0,w.jsx)(ve,{}):e===`/l1-bonus.html`?(0,w.jsx)(pe,{to:`/l1-bonus-preview.html`}):e===`/l1-bonus-preview.html`?(0,w.jsx)(ye,{}):e===`/l1-l2-bonus.html`?(0,w.jsx)(pe,{to:`/l1-l2-bonus-preview.html`}):e===`/l1-l2-bonus-preview.html`?(0,w.jsx)(be,{}):e===`/project-page.html`?(0,w.jsx)(pe,{to:`/workspace-page.html`}):e===`/workspace-page.html`?(0,w.jsx)(xe,{}):(0,w.jsx)(Se,{})}d.createRoot(document.getElementById(`root`)).render((0,w.jsx)(Ce,{}));