...
`)}function Le(e=i.editorValue){if(i.mode!==`js`)return[];let t=String(e||``).split(`
...
`);return!t||!Number.isInteger(t.start)||!Number.isInteger(t.end)?``:n.slice(t.start,t.end+1).join(`
`)}function ze(e){let t=[],n=/\b(?:querySelector(?:All)?|closest|matches)\(\s*(['"`])([\s\S]*?)\1/g,r=n.exec(String(e||``));for(;r;){let i=String(r[2]||``).trim();i&&t.push(i),r=n.exec(String(e||``))}return t}function Be(e,t){let n=ze(e?.source||``);return!n.length||!Array.isArray(t)||!t.length?!1:n.some(e=>t.some(t=>Me(e,t)))}function k(){return E()}function Ve(e){let t=k();return t.length?Le(e).filter(e=>Be(e,t)):[]}function A(){return k().map(e=>N(e)).filter(Boolean).join(`|`)}function He(e){return k().length?Ve(e).map(t=>Re(e,t)).filter(Boolean).join(`

`):String(e||``)}function Ue(){let e=String(i.jsFullValue||p().js||``);if(i.mode!==`js`||!k().length)return i.mode===`js`?i.editorValue:e;let t=Le(e),n=Le(i.editorValue),r=k(),a=n.map(e=>Re(i.editorValue,e)),o=new Map;n.forEach(e=>{let t=ze(e.source).join(`|`),n=o.get(t)||[];n.push(Re(i.editorValue,e)),o.set(t,n)});let s=e.split(`
...
`)}function We(e){if(i.mode!==`js`)return null;let t=l.querySelector(`[data-preview-dev-editor]`);if(!(t instanceof HTMLTextAreaElement))return null;let n=t.getBoundingClientRect(),r=C(t,`line-height`,18.6),a=C(t,`padding-top`,14),o=Math.max(0,Math.floor((e.clientY-n.top+t.scrollTop-a)/r));return Le().find(e=>o>=e.start&&o<=e.end)||null}function Ge(e){let t=j(),n=ze(e?.source||``);if(!(t instanceof Element)||!n.length)return[];let r=[];return n.forEach(e=>{try{(t.matches(e)?[t,...Array.from(t.querySelectorAll(e))]:Array.from(t.querySelectorAll(e))).forEach(e=>{e instanceof Element&&!r.includes(e)&&r.push(e)})}catch{}}),r}function Ke(e){if(i.mode!==`css`)return null;let t=l.querySelector(`[data-preview-dev-editor]`);if(!(t instanceof HTMLTextAreaElement))return null;let n=t.getBoundingClientRect(),r=C(t,`line-height`,18.6),a=C(t,`padding-top`,14),o=Math.max(0,Math.floor((e.clientY-n.top+t.scrollTop-a)/r));return T().find(e=>o>=e.start&&o<=e.end)||null}function qe(e){let t=j();if(!(t instanceof Element)||!e?.selectors?.length)return[];let n=[];return e.selectors.forEach(e=>{try{(t.matches(e)?[t,...Array.from(t.querySelectorAll(e))]:Array.from(t.querySelectorAll(e))).forEach(e=>{e instanceof Element&&!n.includes(e)&&n.push(e)})}catch{}}),n}function Je(){return i.hoveredHtmlLine>=0?i.hoveredHtmlLine:i.previewHoveredHtmlLine}function j(){let e=document.querySelector(`[data-vibe-mobile-render]`)?.querySelector?.(`.vibe-generated-page`);if(e instanceof Element)return e;let t=document.querySelector(`.mobile-page .vibe-generated-page, .vibe-mobile-stage .vibe-generated-page`);return t instanceof Element?t:null}function Ye(){let e=j();return e instanceof Element?[e,...Array.from(e.querySelectorAll(`*`))]:[]}function Xe(e){let t=tt(),n=String(e||``).split(`.`).map(e=>Number.parseInt(e,10));if(!(t instanceof Element)||!n.length||n.some(e=>!Number.isInteger(e)||e<0))return null;let r=t;for(let e of n)if(r=r.children[e]||null,!(r instanceof Element))return null;return r}function Ze(e){return w().find(t=>t.line===e)||null}function Qe(e){if(i.mode!==`html`)return-1;let t=l.querySelector(`[data-preview-dev-editor]`);if(!(t instanceof HTMLTextAreaElement))return-1;let n=t.getBoundingClientRect(),r=C(t,`line-height`,18.6),a=C(t,`padding-top`,14),o=Math.max(0,Math.floor((e.clientY-n.top+t.scrollTop-a)/r));return w().some(e=>e.line===o)?o:-1}function $e(e){if(i.mode!==`html`||!(e instanceof HTMLTextAreaElement))return-1;let t=Number.isFinite(e.selectionStart)?e.selectionStart:0,n=e.value.slice(0,Math.max(0,t)).split(`
`).length-1,r=w(e.value);return r.some(e=>e.line===n)?n:r.filter(e=>e.line<n).sort((e,t)=>t.line-e.line)[0]?.line??-1}function et(e){let t=Ze(e);return t&&Ye()[t.ordinal]||null}function M(e){if(!(e instanceof Element))return-1;let t=Ye().indexOf(e);return t<0?-1:w()[t]?.line??-1}function tt(){let e=document.querySelector(`[data-vibe-mobile-render]`);return e instanceof Element?e:null}function N(e){let t=tt();if(!(e instanceof Element)||!(t instanceof Element)||e===t||!t.contains(e))return``;let n=[],r=e;for(;r instanceof Element&&r!==t;){let e=r.parentElement;if(!(e instanceof Element))return``;let t=Array.from(e.children).indexOf(r);if(t<0)return``;n.unshift(t),r=e}return n.join(`.`)}function nt(){let e=tt();return e instanceof Element?Array.from(e.querySelectorAll(`[data-ux-layer-selected]:not([data-ux-layer-selected="false"])`)).map(e=>N(e)).filter(Boolean):[]}function P(e){let t=j();if(!(t instanceof Element))return null;let n=e instanceof Element?e:e?.parentElement||null;for(;n instanceof Element&&n!==document.body;){if(n===t||t.contains(n))return n;n=n.parentElement}return null}function rt(e,t,n=null){e instanceof Element&&e.dispatchEvent(new MouseEvent(t,{bubbles:!0,cancelable:!0,view:window,relatedTarget:n}))}function it(e=0){if(o[e]instanceof HTMLElement)return o[e];let t=document.createElement(`div`);return t.className=`preview-dev-layer-hover-overlay`,t.setAttribute(`data-preview-dev-layer-hover-overlay`,``),t.innerHTML=`<span class="preview-dev-layer-hover-overlay__label" data-preview-dev-layer-hover-label></span>`,document.body.append(t),o[e]=t,t}function at(e){let t=Math.max(0,e.width),n=Math.max(0,e.height),r=e=>{let t=Math.round(e*100)/100;return String(t)};return`${r(t)} x ${r(n)}`}function ot(){s=0;let e=Array.isArray(i.activePreviewHoverElements)?i.activePreviewHoverElements.filter(e=>e instanceof Element):[];if(!i.open||!e.length){o.forEach(e=>e?.classList?.remove(`is-visible`));return}e.forEach((e,t)=>{let n=it(t),r=e.getBoundingClientRect();if(!e.isConnected||r.width<=0||r.height<=0){n.classList.remove(`is-visible`);return}n.style.left=`${r.left}px`,n.style.top=`${r.top}px`,n.style.width=`${r.width}px`,n.style.height=`${r.height}px`,n.querySelector(`[data-preview-dev-layer-hover-label]`)?.replaceChildren(at(r)),n.classList.toggle(`is-breakpoint-override`,se(N(e))),n.classList.add(`is-visible`)}),o.slice(e.length).forEach(e=>e?.classList?.remove(`is-visible`))}function F(){s||=window.requestAnimationFrame(ot)}function st(e){lt(e>=0?et(e):null)}function ct(e){lt(e?Xe(e):null)}function lt(e){I(e instanceof Element?[e]:[])}function I(e){let t=Array.from(new Set((Array.isArray(e)?e:[]).filter(e=>e instanceof Element))),n=Array.isArray(i.activePreviewHoverElements)?i.activePreviewHoverElements.filter(e=>e instanceof Element):i.activePreviewHoverElement instanceof Element?[i.activePreviewHoverElement]:[];n.length===t.length&&n.every((e,n)=>e===t[n])||(n.filter(e=>!t.includes(e)).forEach(e=>rt(e,`mouseout`,t[0]||document.body)),i.activePreviewHoverElements=t,i.activePreviewHoverElement=t[0]||null,t.filter(e=>!n.includes(e)).forEach(e=>rt(e,`mouseover`,n[0]||document.body)),F())}function L(e){let t=Number.isInteger(e)&&e>=0?e:-1;if(i.hoveredHtmlLine===t){F();return}i.hoveredHtmlLine=t,st(t),U()}function R(e){let t=e&&typeof e==`object`?e:null,n=i.hoveredCssRule;if(!n&&!t||n&&t&&n.start===t.start&&n.end===t.end&&n.selector===t.selector){F();return}i.hoveredCssRule=t,I(t?qe(t):[]),W()}function z(e){let t=e&&typeof e==`object`?e:null,n=i.hoveredJsBlock;if(!n&&!t||n&&t&&n.start===t.start&&n.end===t.end&&n.source===t.source){F();return}i.hoveredJsBlock=t,I(t?Ge(t):[]),G()}function ut({force:e=!1}={}){if(i.mode!==`css`)return;let t=i.cssFilterSignature,n=D(),r=n!==t;if(i.dirty&&!e&&!r)return;let a=i.dirty?O():String(p().css||i.cssFullValue||``);r&&(i.cssShowAll=!1);let o=i.cssShowAll?a:Fe(a);if(!e&&a===i.cssFullValue&&n===i.cssFilterSignature&&o===i.editorValue)return;let s=!!l.querySelector(`[data-preview-dev-css-filter-footer]`),c=l.querySelector(`[data-preview-dev-editor]`),u=c instanceof HTMLTextAreaElement?c.scrollTop:0,d=c instanceof HTMLTextAreaElement?c.scrollLeft:0;if(i.cssFullValue=a,i.cssFilterSignature=n,i.editorValue=o,g(),c instanceof HTMLTextAreaElement&&(c.value=i.editorValue,c.scrollTop=u,c.scrollLeft=d),s!==Ie()){Q();return}b()}function dt({force:e=!1}={}){if(i.mode!==`js`||i.dirty)return;let t=String(p().js||i.jsFullValue||``),n=A(),r=He(t);if(!e&&t===i.jsFullValue&&n===i.jsFilterSignature&&r===i.editorValue)return;let a=l.querySelector(`[data-preview-dev-editor]`),o=a instanceof HTMLTextAreaElement?a.scrollTop:0,s=a instanceof HTMLTextAreaElement?a.scrollLeft:0;i.jsFullValue=t,i.jsFilterSignature=n,i.editorValue=r,g(),a instanceof HTMLTextAreaElement&&(a.value=i.editorValue,a.scrollTop=o,a.scrollLeft=s),b()}function B(e){let t=String(e||``).trim();if(i.hoveredOverridePath===t){F();return}i.hoveredOverridePath=t,ct(t),K()}function V(){if(!i.open)return;let e=j();if(!(e instanceof Element)){i.previewHoveredHtmlLine=-1,i.previewHoveredLayerPath=``,i.previewSelectedLayerPath=``,i.selectedHtmlLine=-1,U(),ut(),W(),dt(),G(),S(),K();return}let t=e.querySelector(`[data-ux-layer-hovered]:not([data-ux-layer-hovered="false"])`),n=e.querySelector(`[data-ux-layer-selected]:not([data-ux-layer-selected="false"])`),r=t instanceof Element?M(t):-1,a=t instanceof Element?N(t):``,o=n instanceof Element?M(n):-1,s=n instanceof Element?N(n):``,c=i.mode===`html`?r:-1,l=i.mode===`html`?o:-1,u=s!==i.previewSelectedLayerPath||l!==i.selectedHtmlLine;(c!==i.previewHoveredHtmlLine||a!==i.previewHoveredLayerPath||s!==i.previewSelectedLayerPath||l!==i.selectedHtmlLine)&&(i.previewHoveredHtmlLine=c,i.previewHoveredLayerPath=a,i.previewSelectedLayerPath=s,i.selectedHtmlLine=l,x(),U(),u&&(!i.cssShowAll||i.allowCssRefilterFromSelection)&&ut(),i.allowCssRefilterFromSelection=!1,W(),u&&dt(),G(),S(),K())}function ft(){let e=document.querySelector(`[data-vibe-mobile-render]`);if(!(e instanceof Element))return``;let t=e.cloneNode(!0);return t instanceof Element?(t.querySelectorAll(`[data-ux-layer-hovered], [data-ux-layer-selected]`).forEach(e=>{e.removeAttribute(`data-ux-layer-hovered`),e.removeAttribute(`data-ux-layer-selected`)}),t.hasAttribute(`data-ux-layer-hovered`)&&t.removeAttribute(`data-ux-layer-hovered`),t.hasAttribute(`data-ux-layer-selected`)&&t.removeAttribute(`data-ux-layer-selected`),t.innerHTML):``}function pt(){if(i.previewDomSyncFrame=0,!i.open||i.mode!==`html`||i.renderingLivePreview)return;let e=ft(),t=ie(e);if(!t||t===i.editorValue)return;let n=l.querySelector(`[data-preview-dev-editor]`),r=n instanceof HTMLTextAreaElement?n.scrollTop:0,a=n instanceof HTMLTextAreaElement?n.scrollLeft:0;i.editorValue=t,i.dirty=!1,i.error=``,i.status=``,i.page?.preview&&(i.page.preview={...i.page.preview,html:e}),i.page?.vibe?.appliedDraft&&(i.page.vibe.appliedDraft={...i.page.vibe.appliedDraft,html:e}),g(),n instanceof HTMLTextAreaElement&&(n.value=i.editorValue,n.scrollTop=r,n.scrollLeft=a),b(),y(),V()}function mt(){i.renderingLivePreview||i.mode!==`html`||(i.previewDomSyncFrame||=window.requestAnimationFrame(pt))}function H({force:e=!1}={}){if(!i.open||!m()||i.overridesDirty)return;let t=h(`overrides`);if(t===i.overridesValue)return;let n=l.querySelector(`[data-preview-dev-overrides-editor]`);if(!e&&n instanceof HTMLTextAreaElement&&document.activeElement===n)return;let r=n instanceof HTMLTextAreaElement?n.scrollTop:0,a=n instanceof HTMLTextAreaElement?n.scrollLeft:0;i.overridesValue=t,i.error=``,i.status=``,n instanceof HTMLTextAreaElement&&(n.value=i.overridesValue,n.scrollTop=r,n.scrollLeft=a),b(),y()}function ht(e={}){if(e.project)Kt(e.project,e.page?.id||r);else if(i.page&&e.breakpointOverrides&&typeof e.breakpointOverrides==`object`){let t={...p(),breakpointOverrides:e.breakpointOverrides};i.page={...i.page,preview:i.page.preview?t:i.page.preview,vibe:i.page.vibe?{...i.page.vibe,appliedDraft:i.page.vibe.appliedDraft?{...i.page.vibe.appliedDraft,breakpointOverrides:e.breakpointOverrides}:i.page.vibe.appliedDraft}:i.page.vibe}}let t=h(`overrides`),n=l.querySelector(`[data-preview-dev-overrides-editor]`),a=n instanceof HTMLTextAreaElement?n.scrollTop:0,o=n instanceof HTMLTextAreaElement?n.scrollLeft:0;i.overridesDirty=!1,i.overridesValue=t,i.error=``,i.status=``,n instanceof HTMLTextAreaElement&&(n.value=t,n.scrollTop=a,n.scrollLeft=o),b(),y()}function gt(){i.overridesSyncTimer||typeof window>`u`||(i.overridesSyncTimer=window.setInterval(()=>H(),250))}function _t(){!i.overridesSyncTimer||typeof window>`u`||(window.clearInterval(i.overridesSyncTimer),i.overridesSyncTimer=0)}function vt(){if(i.open&&m()){gt(),H();return}_t()}function yt(){i.previewDomSyncFrame&&=(window.cancelAnimationFrame(i.previewDomSyncFrame),0)}function bt(){let e=j();if(!(e instanceof Element)){a?.disconnect(),a=null;return}a?.__previewRoot!==e&&(a?.disconnect(),a=new MutationObserver(()=>{V(),mt(),H()}),a.__previewRoot=e,a.observe(e,{subtree:!0,childList:!0,attributes:!0,characterData:!0}),V())}function xt(e){return/\sdata-ux-layer-hidden-control=(["'])true\1/i.test(e)||/\sdata-ux-layer-visible=(["'])false\1/i.test(e)||/\saria-hidden=(["'])true\1/i.test(e)||/style=(["'])[^"']*display\s*:\s*none/i.test(e)||/style=(["'])[^"']*visibility\s*:\s*hidden/i.test(e)}function St(e){return e?`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M2 2l20 20"></path><path d="M10.6 10.6a2 2 0 0 0 2.8 2.8"></path><path d="M9.9 4.2A10.4 10.4 0 0 1 12 4c5 0 9 5 10 8a15.6 15.6 0 0 1-2.1 3.6"></path><path d="M6.5 6.5C4.4 7.9 2.8 10 2 12c1 3 5 8 10 8a10.7 10.7 0 0 0 5.5-1.6"></path></svg>`:`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M2 12s4-7 10-7 10 7 10 7-4 7-10 7S2 12 2 12Z"></path><circle cx="12" cy="12" r="3"></circle></svg>`}function U(){let e=l.querySelector(`[data-preview-dev-layer-gutter]`),t=l.querySelector(`[data-preview-dev-editor]`),n=l.querySelector(`[data-preview-dev-row-highlights]`);if(!(e instanceof HTMLElement)||!(t instanceof HTMLTextAreaElement)||i.mode!==`html`){e instanceof HTMLElement&&(e.innerHTML=``),n instanceof HTMLElement&&(n.innerHTML=``);return}let r=w(),a=Je(),o=i.selectedHtmlLine,s=r.filter(e=>e.hidden||e.line===a),c=C(t,`padding-top`,14),u=C(t,`line-height`,18.6),d=t.scrollTop||0;n instanceof HTMLElement&&(n.innerHTML=r.filter(e=>e.line===a||e.line===o).map(e=>{let t=c+e.line*u-d;return`<div class="preview-dev-panel__row-highlight${e.line===o?` is-selected`:``}" style="top: ${t}px; height: ${u}px;"></div>`}).join(``)),e.innerHTML=s.map(e=>{let t=c+e.line*u-d,n=e.line===a||e.hidden?` is-visible`:``,r=e.hidden?` is-hidden`:``,i=e.hidden?`Unhide HTML layer`:`Hide HTML layer`;return`
          <button
            type="button"
        ...
        `}).join(``)}function W(){let e=l.querySelector(`[data-preview-dev-row-highlights]`),t=l.querySelector(`[data-preview-dev-editor]`);if(!(e instanceof HTMLElement)||!(t instanceof HTMLTextAreaElement)||i.mode!==`css`)return;let n=i.hoveredCssRule;if(!n){e.innerHTML=``;return}let r=C(t,`padding-top`,14),a=C(t,`line-height`,18.6),o=t.scrollTop||0,s=[];for(let e=n.start;e<=n.end;e+=1)s.push(e);e.innerHTML=s.map(e=>`<div class="preview-dev-panel__row-highlight" style="top: ${r+e*a-o}px; height: ${a}px;"></div>`).join(``)}function G(){let e=l.querySelector(`[data-preview-dev-row-highlights]`),t=l.querySelector(`[data-preview-dev-editor]`);if(!(e instanceof HTMLElement)||!(t instanceof HTMLTextAreaElement)||i.mode!==`js`)return;let n=i.hoveredJsBlock;if(!n){e.innerHTML=``;return}let r=C(t,`padding-top`,14),a=C(t,`line-height`,18.6),o=t.scrollTop||0,s=[];for(let e=n.start;e<=n.end;e+=1)s.push(e);e.innerHTML=s.map(e=>`<div class="preview-dev-panel__row-highlight" style="top: ${r+e*a-o}px; height: ${a}px;"></div>`).join(``)}function K(){let e=l.querySelector(`[data-preview-dev-overrides-row-highlights]`),t=l.querySelector(`[data-preview-dev-overrides-editor]`);if(!(e instanceof HTMLElement)||!(t instanceof HTMLTextAreaElement)){e instanceof HTMLElement&&(e.innerHTML=``);return}let n=Ae(),r=i.hoveredOverridePath||i.previewHoveredLayerPath,a=r?De(i.overridesValue,r):null,o=new Set;if(a)for(let e=a.start;e<=a.end;e+=1)o.add(e);if(!n.size&&!o.size){e.innerHTML=``;return}let s=C(t,`padding-top`,14),c=C(t,`line-height`,18.6),u=t.scrollTop||0;e.innerHTML=Array.from(new Set([...o,...n])).sort((e,t)=>e-t).map(e=>{let t=s+e*c-u;return`<div class="preview-dev-panel__row-highlight${n.has(e)?` is-selected`:``}" style="top: ${t}px; height: ${c}px;"></div>`}).join(``)}function Ct(e){return String(e).replace(/[.*+?^${}()|[\]\\]/g,`\\$&`)}function wt(e){return String(e).replace(/&/g,`&amp;`).replace(/"/g,`&quot;`)}function q(e,t,n){let r=RegExp(`\\s${Ct(t)}(?:=(?:"[^"]*"|'[^']*'|[^\\s>]+))?`,`i`),i=` ${t}="${wt(n)}"`;return r.test(e)?e.replace(r,i):e.replace(/\s*(\/?>)$/,`${i}$1`)}function J(e,t){let n=RegExp(`\\s${Ct(t)}(?:=(?:"[^"]*"|'[^']*'|[^\\s>]+))?`,`ig`);return e.replace(n,``)}function Tt(e,t){let n=RegExp(`\\s${Ct(t)}=(["'])([\\s\\S]*?)\\1`,`i`),r=e.match(n);return r?r[2]:``}function Et(e){let t=e.match(/\sstyle=(["'])([\s\S]*?)\1/i);return t?{quote:t[1],value:t[2]}:null}function Dt(e,t){let n=Et(e);if(!n)return``;let r=String(t||``).trim().toLowerCase();if(!r)return``;let i=n.value.split(`;`).map(e=>e.trim()).filter(Boolean).find(e=>{let t=e.indexOf(`:`);return t>=0&&e.slice(0,t).trim().toLowerCase()===r});return i?i.slice(i.indexOf(`:`)+1).trim():``}function Ot(e,t){let n=Et(e),r=new Map;n&&n.value.split(`;`).map(e=>e.trim()).filter(Boolean).forEach(e=>{let t=e.indexOf(`:`);if(t<0)return;let n=e.slice(0,t).trim().toLowerCase(),i=e.slice(t+1).trim();n&&r.set(n,i)}),Object.entries(t).forEach(([e,t])=>{let n=e.toLowerCase();t==null?r.delete(n):r.set(n,t)});let i=Array.from(r.entries()).map(([e,t])=>`${e}: ${t}`).join(`; `);return i?q(e,`style`,`${i};`):J(e,`style`)}function kt(e,t){let n=e.match(/^(\s*)(<[^>]+>)([\s\S]*)$/);if(!n)return e;let r=n[2];if(t){let e=Dt(r,`display`);e&&e.toLowerCase()!==`none`&&(r=q(r,`data-ux-layer-display-cache`,e)),r=q(r,`data-ux-layer-hidden-control`,`true`),r=q(r,`data-ux-layer-visible`,`false`),r=q(r,`aria-hidden`,`true`),r=Ot(r,{display:`none`,visibility:null,"pointer-events":null})}else{let e=Tt(r,`data-ux-layer-display-cache`);r=J(r,`data-ux-layer-hidden-control`),r=J(r,`data-ux-layer-visible`),r=J(r,`data-ux-layer-display-cache`),r=J(r,`aria-hidden`),r=Ot(r,{display:e||null,visibility:null,"pointer-events":null})}return`${n[1]}${r}${n[3]}`}function At(e){if(i.mode!==`html`||!Number.isInteger(e)||e<0)return;let t=l.querySelector(`[data-preview-dev-editor]`),n=String(i.editorValue||``).split(`
`);if(!n[e])return;let r=!xt(n[e]);if(n[e]=kt(n[e],r),i.editorValue=n.join(`
`),i.dirty=!0,i.error=``,i.status=``,yt(),ue(i.editorValue,e),t instanceof HTMLTextAreaElement){let e=t.scrollTop,n=t.scrollLeft;t.value=i.editorValue,t.scrollTop=e,t.scrollLeft=n,t.focus()}b(),y(),Y(),X()}function jt(){let e=p(),t={...e,html:String(e.html||``),css:String(e.css||``),js:String(e.js||``),stageStyle:String(e.stageStyle||``),breakpointOverrides:e.breakpointOverrides||{}};return i.mode===`html`?t.html=i.editorValue:i.mode===`css`?t.css=O():i.mode===`js`&&(t.js=Ue()),t.breakpointOverrides=JSON.parse(i.overridesValue||`{}`),t}function Mt(e){!i.page||!e||(i.page.preview=e,i.page.hasContent=!!e.html,i.page.vibe={...i.page.vibe||{},status:`applied`,appliedDraft:e,summary:e.summary||i.page.vibe?.summary||``})}function Nt(e){let t=e?.__uxBridgePreviewCleanup;if(typeof t==`function`)try{t()}catch(e){console.warn(`[dev-mode] preview.js cleanup failed`,e)}e&&(e.__uxBridgePreviewCleanup=null)}function Pt(e,t){Nt(e);let n=String(t?.js||``).trim();if(!e||!n)return;let r=e.firstElementChild instanceof HTMLElement?e.firstElementChild:e;try{let t=Function(`root`,`page`,`project`,`api`,n)(r,i.page,i.project,{});typeof t==`function`&&(e.__uxBridgePreviewCleanup=t)}catch(e){console.warn(`[dev-mode] preview.js failed`,e)}}function Ft(e){let t=document.querySelector(`.mobile-page`),n=document.querySelector(`[data-empty-mobile-shell]`),r=document.querySelector(`[data-vibe-mobile-stage]`),a=document.querySelector(`[data-vibe-mobile-style]`),o=document.querySelector(`[data-vibe-mobile-render]`);if(!t||!n||!r||!a||!o)return;let s=!!e?.html;t.classList.toggle(`mobile-page--empty`,!s),n.hidden=s,r.hidden=!s,i.renderingLivePreview=!0;try{if(!s){Nt(o),a.textContent=``,o.innerHTML=``;return}a.textContent=String(e.css||``),o.innerHTML=String(e.html||``),Pt(o,e)}finally{window.requestAnimationFrame(()=>{i.renderingLivePreview=!1,bt(),V()})}}function Y(){let e;try{e=jt()}catch(e){return i.error=e instanceof Error?e.message:`Overrides must be valid JSON.`,!1}return i.error=``,Mt(e),Ft(e),window.dispatchEvent(new CustomEvent(`uxbridge:preview-code-live-update`,{detail:{projectId:i.project?.id||n,pageId:i.page?.id||r||document.body.dataset.pageKey||``,preview:e}})),!0}function X(e=`main`){try{i.pendingAutosavePayload={...Wt(),__mode:i.mode,__editorKey:e,__value:e===`overrides`?i.overridesValue:i.editorValue}}catch(e){i.error=e instanceof Error?e.message:`Overrides must be valid JSON.`;return}i.autosaveTimer&&window.clearTimeout(i.autosaveTimer),i.autosaveTimer=window.setTimeout(()=>{i.autosaveTimer=0,Gt()},450)}function Z(e){if(!(e instanceof Element))return!1;i.allowCssRefilterFromSelection=!0;let t=e.getBoundingClientRect(),n=t.left+Math.max(1,Math.min(t.width/2,t.width-1)),r=t.top+Math.max(1,Math.min(t.height/2,t.height-1)),a={bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:n,clientY:r,button:0,buttons:1};return typeof PointerEvent==`function`&&(e.dispatchEvent(new PointerEvent(`pointerdown`,{...a,pointerId:1,pointerType:`mouse`})),e.dispatchEvent(new PointerEvent(`pointerup`,{...a,pointerId:1,pointerType:`mouse`,buttons:0}))),e.dispatchEvent(new MouseEvent(`mousedown`,a)),e.dispatchEvent(new MouseEvent(`mouseup`,{...a,buttons:0})),e.dispatchEvent(new MouseEvent(`click`,{...a,buttons:0})),window.requestAnimationFrame(V),!0}function It(e){let t=et(e);t instanceof Element&&(i.selectedHtmlLine=e,x(),U(),S(),K(),Z(t))}function Lt(e){let t=$e(e);t>=0&&It(t)}function Q(){_({preserveDirty:!0});let e=ce(),t=m(),n=Ie(),r=`preview-dev-panel__body${n?` has-filter-footer`:``}`,a=n?`
    ...
    `,Rt(),v(),ye(),bt(),x(),S(),U(),K(),vt(),F()}function Rt(){let e=document.querySelector(`[data-preview-dev-toggle]`);e instanceof HTMLButtonElement&&(e.classList.toggle(`is-active`,i.open),e.setAttribute(`aria-expanded`,i.open?`true`:`false`))}let zt=null,Bt=!1;function Vt(e){return e instanceof Element?e.matches(`[data-vibe-drawer-toggle], [data-customizer-drawer-toggle]`)?20:e.matches(`[data-comments-drawer-toggle]`)?30:e.matches(`[data-uploads-drawer-toggle]`)?40:e.matches(`[data-preview-dev-divider]`)?90:e.matches(`[data-preview-dev-toggle]`)?100:10:50}function $(){let e=document.querySelector(`[data-side-actions]`);if(!(e instanceof HTMLElement)||Bt)return;let t=Array.from(e.children),n=t.map((e,t)=>({node:e,index:t,rank:Vt(e)})).sort((e,t)=>e.rank-t.rank||e.index-t.index).map(e=>e.node);if(!n.every((e,n)=>e===t[n])){Bt=!0;try{n.forEach(t=>e.append(t))}finally{Bt=!1}}}function Ht(){let e=document.querySelector(`[data-side-actions]`);!(e instanceof HTMLElement)||zt||(zt=new MutationObserver(()=>{window.requestAnimationFrame($)}),zt.observe(e,{childList:!0}))}function Ut(e){i.open=!!e,i.open&&_(),Q()}l.addEventListener(`pointerdown`,e=>{let t=e.target;if(!(t instanceof Element))return;let n=t.closest(`[data-preview-dev-layer-toggle]`);if(!n){if(t.closest(`[data-preview-dev-split-resize-handle]`)){e.preventDefault(),e.stopPropagation(),be(e);return}t.closest(`[data-preview-dev-resize-handle]`)&&(e.preventDefault(),e.stopPropagation(),me(e));return}e.preventDefault(),e.stopPropagation(),At(Number.parseInt(String(n.getAttribute(`data-preview-dev-line`)||``),10))},!0),document.addEventListener(`pointermove`,e=>{he(e),xe(e)}),document.addEventListener(`pointerup`,()=>{ge(),Se()}),document.addEventListener(`pointercancel`,()=>{ge(),Se()}),document.addEventListener(`pointerdown`,e=>{!i.open||l.contains(e.target)||P(e.target)instanceof Element&&(i.allowCssRefilterFromSelection=!0)},!0),l.addEventListener(`click`,e=>{let t=e.target;if(!(t instanceof Element))return;if(e.stopPropagation(),t.closest(`[data-preview-dev-close]`)){e.preventDefault(),Ut(!1);return}let n=t.closest(`[data-preview-dev-layer-toggle]`);if(n){e.preventDefault(),e.stopPropagation();let t=Number.parseInt(String(n.getAttribute(`data-preview-dev-line`)||``),10);e.detail===0&&At(t);return}if(t.closest(`[data-preview-dev-css-see-all]`)){e.preventDefault();let t=O();i.cssShowAll=!0,i.cssFullValue=t,i.editorValue=t,i.dirty=!0,i.error=``,i.status=``,i.hoveredCssRule=null,I([]),g(),Y(),X(),Q();return}let r=t.closest(`[data-preview-dev-tab]`);if(r){e.preventDefault(),e.stopPropagation();let t=String(r.getAttribute(`data-preview-dev-tab`)||``).trim();if(!t||t===i.mode)return;i.mode=t,i.mode===`css`?(i.cssFullValue=String(p().css||``),i.cssFilterSignature=D()):i.mode===`js`&&(i.jsFullValue=String(p().js||``),i.jsFilterSignature=A()),i.editorValue=h(t),i.dirty=!1,i.error=``,i.status=``,i.hoveredHtmlLine=-1,i.hoveredCssRule=null,i.hoveredJsBlock=null,i.hoveredOverridePath=``,I([]),g(),Q();return}if(t instanceof HTMLTextAreaElement&&t.matches(`[data-preview-dev-editor]`)){window.requestAnimationFrame(()=>{if(x(),i.mode===`html`)Lt(t);else if(i.mode===`css`){let t=qe(Ke(e))[0]||null;t instanceof Element&&Z(t)}else if(i.mode===`js`){let t=Ge(We(e))[0]||null;t instanceof Element&&Z(t)}});return}if(t instanceof HTMLTextAreaElement&&t.matches(`[data-preview-dev-overrides-editor]`)){window.requestAnimationFrame(()=>{S();let t=Xe(ke(e));t instanceof Element&&Z(t)});return}if(t.closest(`[data-preview-dev-body]`)&&i.mode===`html`){let t=Qe(e);t>=0&&It(t)}}),l.addEventListener(`pointerdown`,e=>{let t=e.target;t instanceof Element&&t.closest(`[data-preview-dev-tab]`)&&e.stopPropagation()},!0),l.addEventListener(`mousedown`,e=>{let t=e.target;t instanceof Element&&t.closest(`[data-preview-dev-tab]`)&&e.stopPropagation()},!0),l.addEventListener(`pointerdown`,e=>{e.stopPropagation()}),l.addEventListener(`mousedown`,e=>{e.stopPropagation()}),l.addEventListener(`input`,e=>{let t=e.target;if(t instanceof HTMLTextAreaElement){if(t.matches(`[data-preview-dev-overrides-editor]`)){i.overridesValue=t.value,i.overridesDirty=!0,i.status=``,i.error=``,b(),Y(),X(`overrides`);return}t.matches(`[data-preview-dev-editor]`)&&(i.editorValue=t.value,i.dirty=!0,i.status=``,i.error=``,ue(i.editorValue,le(t.value,t.selectionStart||0)),b(),Y(),X())}}),l.addEventListener(`scroll`,e=>{let t=e.target;t instanceof HTMLTextAreaElement&&(t.matches(`[data-preview-dev-editor]`)||t.matches(`[data-preview-dev-overrides-editor]`))&&y()},!0),l.addEventListener(`pointermove`,e=>{let t=e.target;if(t instanceof Element){if(t.closest(`[data-preview-dev-overrides-body]`)){L(-1),R(null),z(null),B(ke(e));return}if(i.mode===`css`&&t.closest(`[data-preview-dev-body]`)){L(-1),B(``),z(null),R(Ke(e));return}if(i.mode===`js`&&t.closest(`[data-preview-dev-body]`)){L(-1),R(null),B(``),z(We(e));return}i.mode!==`html`||!t.closest(`[data-preview-dev-body]`)||(R(null),z(null),B(``),L(Qe(e)))}}),l.addEventListener(`pointerleave`,e=>{let t=e.relatedTarget;t instanceof Node&&l.contains(t)||(L(-1),R(null),z(null),B(``))}),l.addEventListener(`keyup`,e=>{let t=e.target;if(t instanceof HTMLTextAreaElement){if(t.matches(`[data-preview-dev-overrides-editor]`)){new Set([`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`,`Home`,`End`,`PageUp`,`PageDown`]).has(e.key)&&S();return}t.matches(`[data-preview-dev-editor]`)&&new Set([`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`,`Home`,`End`,`PageUp`,`PageDown`]).has(e.key)&&(x(),i.mode===`html`&&Lt(t))}}),l.addEventListener(`select`,e=>{let t=e.target;if(t instanceof HTMLTextAreaElement){if(t.matches(`[data-preview-dev-overrides-editor]`)){window.requestAnimationFrame(S);return}t.matches(`[data-preview-dev-editor]`)&&window.requestAnimationFrame(()=>{x(),i.mode===`html`&&Lt(t)})}}),document.addEventListener(`mouseover`,e=>{if(!i.open||l.contains(e.target))return;let t=P(e.target),n=M(t),r=N(t);(r!==i.previewHoveredLayerPath||i.mode===`html`&&n>=0&&n!==i.previewHoveredHtmlLine)&&(i.previewHoveredLayerPath=r,i.previewHoveredHtmlLine=i.mode===`html`?n:-1,U(),K())}),document.addEventListener(`mouseout`,e=>{if(!i.open||l.contains(e.target))return;let t=P(e.target);if(!(t instanceof Element))return;let n=P(e.relatedTarget);n===t||n instanceof Element&&t.contains(n)||(i.previewHoveredHtmlLine!==-1||i.previewHoveredLayerPath)&&(i.previewHoveredHtmlLine=-1,i.previewHoveredLayerPath=``,U(),K())}),document.addEventListener(`click`,e=>{if(i.mode!==`html`||!i.open||l.contains(e.target))return;let t=M(P(e.target));t>=0&&(i.allowCssRefilterFromSelection=!0,i.selectedHtmlLine=t,U(),window.requestAnimationFrame(V))}),l.addEventListener(`keydown`,e=>{let t=e.target;if(!(t instanceof HTMLTextAreaElement))return;let n=t.matches(`[data-preview-dev-overrides-editor]`);if(!(!n&&!t.matches(`[data-preview-dev-editor]`))&&!(n&&(e.metaKey||e.ctrlKey)&&(e.key.toLowerCase()===`z`||e.key.toLowerCase()===`y`))){if((e.metaKey||e.ctrlKey)&&e.key.toLowerCase()===`z`){e.preventDefault(),de(e.shiftKey?1:-1,t);return}if((e.metaKey||e.ctrlKey)&&e.key.toLowerCase()===`y`){e.preventDefault(),de(1,t);return}if(e.key===`Tab`){e.preventDefault();let n=t.selectionStart||0,r=t.selectionEnd||0;t.value=`${t.value.slice(0,n)}  ${t.value.slice(r)}`,t.selectionStart=t.selectionEnd=n+2,t.dispatchEvent(new Event(`input`,{bubbles:!0}))}}});function Wt(){let e=p(),t={action:`savePreviewContentEdits`,project:i.project?.id||n,page:i.page?.id||r||document.body.dataset.pageKey||``,html:String(e.html||``),css:String(e.css||``),js:String(e.js||``),stageStyle:String(e.stageStyle||``),summary:String(e.summary||i.page?.vibe?.summary||``),syncBase:!0,breakpointOverrides:e.breakpointOverrides||{}};return i.mode===`html`?t.html=i.editorValue:i.mode===`css`?t.css=O():i.mode===`js`&&(t.js=Ue()),t.breakpointOverrides=JSON.parse(i.overridesValue||`{}`),t}async function Gt(){if(!i.page||!i.project||i.saving)return;let t;try{t=i.pendingAutosavePayload||Wt()}catch(e){i.error=e instanceof Error?e.message:`Overrides must be valid JSON.`,i.status=``;return}let n=t.__mode||i.mode,r=t.__editorKey||`main`,a=t.__value??i.editorValue;delete t.__mode,delete t.__editorKey,delete t.__value,i.pendingAutosavePayload=null;let o=i.saveRequestId+1;i.saving=!0,i.error=``,i.status=`Saving`,i.saveRequestId=o;try{let s=await fetch(e,{method:`POST`,credentials:`include`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),c=await s.json().catch(()=>({}));if(!s.ok||!c?.ok||!c?.project)throw Error(c?.error||`Unable to save preview code.`);if(o!==i.saveRequestId)return;let l=r===`overrides`?i.overridesValue===a:i.mode===n&&i.editorValue===a,u=i.dirty,d=i.overridesDirty;l&&(r===`overrides`?i.overridesDirty=!1:i.dirty=!1),Kt(c.project,t.page),i.dirty=(r===`overrides`||!l)&&u,i.overridesDirty=r===`overrides`?!l&&d:d,l&&(r===`overrides`?i.overridesDirty=!1:i.dirty=!1),i.status=`Saved`}catch(e){i.error=e instanceof Error?e.message:`Unable to save preview code.`,i.status=``}finally{o===i.saveRequestId&&(i.saving=!1)}}function Kt(e,t=r){let n=String(t||document.body.dataset.pageKey||r||``).trim().toLowerCase(),a=Array.isArray(e?.pages)?e.pages:[],o=a.find(e=>String(e?.id||``).trim().toLowerCase()===n)||a[0]||null;i.project=e||null,i.page=o,i.cssFullValue=String(p().css||``),i.cssFilterSignature=i.mode===`css`?D():``,i.jsFullValue=String(p().js||``),i.jsFilterSignature=i.mode===`js`?A():``,i.dirty||(i.editorValue=h(i.mode)),i.overridesDirty||(i.overridesValue=h(`overrides`)),H({force:!0})}async function qt(){try{let t=await fetch(`${e}?project=${encodeURIComponent(n)}`,{credentials:`include`,cache:`no-store`}),i=await t.json().catch(()=>({}));t.ok&&i?.ok&&i?.project&&(Kt(i.project,r),_(),Q())}catch{}}function Jt(){let e=document.querySelector(`[data-side-actions]`);if(!e)return!1;if(document.querySelector(`[data-preview-dev-toggle]`))return Ht(),$(),!0;if(!e.querySelector(`[data-uploads-drawer-toggle]`))return!1;let t=document.createElement(`span`);t.className=`preview-dev-divider`,t.setAttribute(`data-preview-dev-divider`,``),t.setAttribute(`aria-hidden`,`true`);let n=document.createElement(`button`);return n.type=`button`,n.className=`bridge-action-rail-button preview-dev-toggle`,n.setAttribute(`data-preview-dev-toggle`,``),n.setAttribute(`aria-expanded`,`false`),n.setAttribute(`aria-label`,`Dev Mode`),n.innerHTML=`
    ...
    `,n.addEventListener(`click`,()=>Ut(!i.open)),e.append(t,n),Ht(),$(),Rt(),!0}function Yt(){let e=0,t=window.setInterval(()=>{e+=1,(Jt()||e>80)&&window.clearInterval(t)},100)}window.addEventListener(`uxbridge:project-page-sync`,e=>{e.detail?.project&&(Kt(e.detail.project,e.detail.page?.id||r),_({preserveDirty:!0}),Q())}),window.addEventListener(`uxbridge:breakpoint-overrides-change`,e=>{ht(e.detail||{})}),new MutationObserver(()=>{let e=m();if(!i.open){Rt(),i.renderedBreakpointMode=e,vt();return}if(i.renderedBreakpointMode!==e){_({preserveDirty:!0}),Q();return}v(),vt()}).observe(document.body,{attributes:!0,attributeFilter:[`class`]}),window.addEventListener(`resize`,()=>{v(),ye(),F()}),document.addEventListener(`scroll`,F,!0),window.addEventListener(`uxbridge:drawer-open`,()=>{window.requestAnimationFrame(v),window.requestAnimationFrame($),window.requestAnimationFrame(ot)}),window.addEventListener(`uxbridge:preview-layout-change`,()=>{window.requestAnimationFrame(v),window.requestAnimationFrame($),window.requestAnimationFrame(ot)}),Yt(),qt(),Q()})();