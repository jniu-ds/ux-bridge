...
<html lang="en" style="visibility: hidden">
  ...
  <body class="bridge-body bridge-body--project" data-dynamic-project="true">
    <div class="bridge-layout bridge-layout--project" data-bridge-shell hidden>
      <aside class="bridge-sidebar" data-bridge-sidebar>
        <a class="bridge-sidebar__back" href="./projects.html" data-home-link="true" aria-label="Back to Projects">
          <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        <nav class="bridge-sidebar__nav" aria-label="Project pages">
          <p class="bridge-sidebar__project-label bridge-sidebar__nav-label">Pages</p>
          <div class="bridge-sidebar__nav-pages" data-project-nav-pages></div>
          <button class="bridge-sidebar__add-page" type="button" data-add-project-page>Add Page</button>
        </nav>
      </aside>
      ...
      <section class="bridge-main bridge-main--project">
        <header class="bridge-project-toolbar">
          <div class="bridge-project-toolbar__heading">
            ...
            <div>
              <p class="bridge-back-link">
                <span data-project-name>Project</span>
              </p>
              <div class="bridge-project-page-title" data-page-title-shell>
                <h1 data-project-page-title>Page</h1>
                <button
              ...
              <section class="mobile-page mobile-page--empty">
                <header class="empty-mobile-taskbar" aria-hidden="true">
                  ...
                  <div class="empty-mobile-taskbar__status">
                    ...
                    <span class="empty-mobile-taskbar__wifi" aria-hidden="true"></span>
                ...
                <section class="empty-mobile-shell" data-empty-mobile-shell>
                  ...
                  <p>Start building this page with Codex when you’re ready.</p>
                  <div class="empty-mobile-shell__actions">
                    <button type="button" class="empty-mobile-shell__cta" data-vibe-launch>Edit with Codex</button>
    ...
    <script src="./customizer.js"><\/script>
    <script src="./comments-panel.js"><\/script>
    <script src="./dev-mode-drawer.js"><\/script>
    <script src="./viewer-presence.js"><\/script>
  </body>
</html>
`;function ie(e,t){let n=new DOMParser().parseFromString(e,`text/html`).querySelector(t);return n?n.outerHTML:``}var ae=ie(y,`main.auth-layout`),oe=ie(b,`div[data-bridge-shell]`),se=ie(x,`div[data-bridge-shell]`),ce=ie(ee,`div[data-bridge-shell]`),le=ie(S,`main.auth-layout`),ue=ie(C,`div[data-bridge-shell]`),T=ie(te,`div[data-bridge-shell]`),E=ie(ne,`div[data-bridge-shell]`),de=ie(re,`div[data-bridge-shell]`),fe=ie(w,`div[data-bridge-shell]`);function pe({title:e,bodyClass:t=``,bodyDataset:n={},scriptLoaders:r=[]}){(0,_.useLayoutEffect)(()=>{document.title=e;let i=t.includes(`bridge-body--project`),a=n.dynamicProject===`true`,o=window.location.pathname===`/project-overview.html`,s=(window.visualViewport?.width||window.innerWidth)>=641,c=(()=>{try{return window.sessionStorage.getItem(`ux-bridge-project-nav-open`)===`true`}catch{return!1}})(),l=(()=>{try{return!!window.sessionStorage.getItem(`ux-bridge-user`)}catch{return!1}})(),u=!window.__uxBridgePageBooted&&!l;if(t.includes(`bridge-body--project`)){let e=document.querySelector(`.bridge-main--project`),t=document.querySelector(`.bridge-project-toolbar`),n=document.querySelector(`.app-shell`),r=window.visualViewport?.width||window.innerWidth,i=window.visualViewport?.height||window.innerHeight,a=e?window.getComputedStyle(e):null,o=n?window.getComputedStyle(n):null,s=t?window.getComputedStyle(t):null,c=a&&Number.parseFloat(a.paddingTop)||0,l=a&&Number.parseFloat(a.paddingBottom)||0,u=a&&Number.parseFloat(a.paddingLeft)||0,d=a&&Number.parseFloat(a.paddingRight)||0,f=o&&Number.parseFloat(o.paddingTop)||0,p=o&&Number.parseFloat(o.paddingBottom)||0,m=o&&Number.parseFloat(o.paddingLeft)||0,h=o&&Number.parseFloat(o.paddingRight)||0,g=t?t.getBoundingClientRect().height:0,_=s&&Number.parseFloat(s.marginBottom)||0,v=Math.max(e?i-c-l-g-_-f-p:window.innerHeight-40,0),y=Math.max(e?r-u-d-m-h:window.innerWidth-28,0),b=Math.min(v/812,y/375);document.documentElement.style.setProperty(`--phone-scale`,String(b))}u?document.documentElement.style.visibility=`hidden`:document.documentElement.style.visibility=`visible`;let d=t.split(/\s+/).filter(Boolean),f=o?c:s;if(i&&f&&d.push(`bridge-nav-open`),i&&f&&d.push(`bridge-nav-restoring`),document.body.className=d.join(` `),i&&!a)try{let e=window.sessionStorage.getItem(`ux-bridge-project-nav-order:brand-affiliate-mobile`);if(e){let t=document.querySelector(`[data-project-nav-pages]`);if(t){let n=Array.from(t.querySelectorAll(`[data-project-page-item]`)),r=new Map(n.map(e=>[e.dataset.projectPageItem,e])),i=n.map(e=>e.dataset.projectPageItem).filter(Boolean),a=JSON.parse(e),o=Array.isArray(a)?a.filter((e,t)=>i.includes(e)&&a.indexOf(e)===t):[];[...o,...i.filter(e=>!o.includes(e))].forEach(e=>{let n=r.get(e);n&&t.append(n)})}}}catch{}Object.keys(document.body.dataset).forEach(e=>{delete document.body.dataset[e]}),Object.entries(n).forEach(([e,t])=>{t!=null&&(document.body.dataset[e]=t)});let p=!1;return(async()=>{for(let e of r){if(p)return;await e()}p||(window.__uxBridgePageBooted=!0,document.documentElement.style.visibility=`visible`)})(),()=>{p=!0}},[e,t,n,r])}var me=o((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),D=o(((e,t)=>{t.exports=me()}))(),O=`modulepreload`,he=function(e){return`/`+e},ge={},k=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=he(t,n),t in ge)return;ge[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:O,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})};function _e({html:e}){return(0,D.jsx)(`div`,{style:{display:`contents`},dangerouslySetInnerHTML:{__html:e}})}function ve({to:e}){return(0,_.useEffect)(()=>{window.location.replace(e)},[e]),null}function ye(){return pe({title:`Sign In | UX Bridge`,bodyClass:`auth-page`,scriptLoaders:(0,_.useMemo)(()=>[()=>k(()=>import(`./auth-page-lIkOTcH2.js`),[])],[])}),(0,D.jsx)(_e,{html:ae})}function be(){return pe({title:`Reset Password | UX Bridge`,bodyClass:`auth-page`,scriptLoaders:(0,_.useMemo)(()=>[()=>k(()=>import(`./reset-password-kt03o3L7.js`),[])],[])}),(0,D.jsx)(_e,{html:le})}function xe(){return pe({title:`UX Bridge`,bodyClass:`bridge-body`,scriptLoaders:(0,_.useMemo)(()=>[()=>k(()=>import(`./auth-gate-Bl-aP-3C.js`),[]),()=>k(()=>import(`./projects-home-BR3vKtcc.js`),[])],[])}),(0,D.jsx)(_e,{html:oe})}function Se(){return pe({title:`UX Bridge | Admin`,bodyClass:`bridge-body`,bodyDataset:{adminPage:`true`},scriptLoaders:(0,_.useMemo)(()=>[()=>k(()=>import(`./auth-gate-Bl-aP-3C.js`),[]),()=>k(()=>import(`./admin-users-CoglYict.js`),[])],[])}),(0,D.jsx)(_e,{html:se})}function Ce(){return pe({title:`UX Bridge | Profile`,bodyClass:`bridge-body`,bodyDataset:{profilePage:`true`},scriptLoaders:(0,_.useMemo)(()=>[()=>k(()=>import(`./auth-gate-Bl-aP-3C.js`),[]),()=>k(()=>import(`./profile-page-DdHKLicC.js`),[])],[])}),(0,D.jsx)(_e,{html:ce})}function we(){return pe({title:`UX Bridge | Brand Affiliate Overview`,bodyClass:`bridge-body bridge-body--project bridge-body--overview`,scriptLoaders:(0,_.useMemo)(()=>[()=>k(()=>import(`./auth-gate-Bl-aP-3C.js`),[]),()=>k(()=>import(`./thumbnail-capture-CpVnHhZy.js`),[]),()=>k(()=>import(`./project-share-DX_i9Pq8.js`),[]),()=>k(()=>import(`./comments-panel-BCpGLbYb.js`),[])],[])}),(0,D.jsx)(_e,{html:ue})}function Te(){return pe({title:`UX Bridge | Brand Affiliate Building`,bodyClass:`bridge-body bridge-body--project`,scriptLoaders:(0,_.useMemo)(()=>[()=>k(()=>import(`./auth-gate-Bl-aP-3C.js`),[]),()=>k(()=>import(`./thumbnail-capture-CpVnHhZy.js`),[]),()=>k(()=>import(`./project-share-DX_i9Pq8.js`),[]),()=>k(()=>import(`./capture-mode-CJNL3W1-.js`),[]),()=>k(()=>import(`./viewport-scale-DoOVC4Ln.js`),[]),()=>k(()=>import(`./comments-panel-BCpGLbYb.js`),[]),()=>k(()=>import(`./building-preview-3WbZS3pf.js`),[])],[])}),(0,D.jsx)(_e,{html:T})}function Ee(){return pe({title:`UX Bridge | L1 Bonus`,bodyClass:`bridge-body bridge-body--project`,bodyDataset:{page:`l1`},scriptLoaders:(0,_.useMemo)(()=>[()=>k(()=>import(`./auth-gate-Bl-aP-3C.js`),[]),()=>k(()=>import(`./thumbnail-capture-CpVnHhZy.js`),[]),()=>k(()=>import(`./project-share-DX_i9Pq8.js`),[]),()=>k(()=>import(`./capture-mode-CJNL3W1-.js`),[]),()=>k(()=>import(`./viewport-scale-DoOVC4Ln.js`),[]),()=>k(()=>import(`./comments-panel-BCpGLbYb.js`),[]),()=>k(()=>import(`./customizer-bQZjcCD9.js`),[]),()=>k(()=>import(`./estimated-earnings-_CeoWfNU.js`),[]),()=>k(()=>import(`./incentive-carousel-DMwKcVBJ.js`),[])],[])}),(0,D.jsx)(_e,{html:E})}function De(){return pe({title:`UX Bridge | L1/L2 Bonus`,bodyClass:`bridge-body bridge-body--project`,bodyDataset:{page:`l1l2`},scriptLoaders:(0,_.useMemo)(()=>[()=>k(()=>import(`./auth-gate-Bl-aP-3C.js`),[]),()=>k(()=>import(`./thumbnail-capture-CpVnHhZy.js`),[]),()=>k(()=>import(`./project-share-DX_i9Pq8.js`),[]),()=>k(()=>import(`./capture-mode-CJNL3W1-.js`),[]),()=>k(()=>import(`./viewport-scale-DoOVC4Ln.js`),[]),()=>k(()=>import(`./comments-panel-BCpGLbYb.js`),[]),()=>k(()=>import(`./customizer-bQZjcCD9.js`),[]),()=>k(()=>import(`./estimated-earnings-_CeoWfNU.js`),[]),()=>k(()=>import(`./incentive-carousel-DMwKcVBJ.js`),[])],[])}),(0,D.jsx)(_e,{html:de})}function Oe(){return pe({title:`UX Bridge | Project Page`,bodyClass:`bridge-body bridge-body--project`,bodyDataset:{dynamicProject:`true`},scriptLoaders:(0,_.useMemo)(()=>[()=>k(()=>import(`./auth-gate-Bl-aP-3C.js`),[]),()=>k(()=>import(`./thumbnail-capture-CpVnHhZy.js`),[]),()=>k(()=>import(`./project-share-DX_i9Pq8.js`),[]),()=>k(()=>import(`./capture-mode-CJNL3W1-.js`),[]),()=>k(()=>import(`./viewport-scale-DoOVC4Ln.js`),[]),()=>k(()=>import(`./project-page-runtime-09Hx9eYu.js`),[]),()=>k(()=>import(`./vibe-drawer-CCI7J6uc.js`),[]),()=>k(()=>import(`./figma-import-runtime-TlmLF_zd.js`),[]),()=>k(()=>import(`./comments-panel-BCpGLbYb.js`),[]),()=>k(()=>import(`./dev-mode-drawer-CalQA4mp.js`),[]),()=>k(()=>import(`./customizer-bQZjcCD9.js`),[])],[])}),(0,D.jsx)(_e,{html:fe})}function ke(){return(0,_.useEffect)(()=>{document.title=`UX Bridge`,document.body.className=`bridge-body`,document.documentElement.style.visibility=`visible`},[]),(0,D.jsx)(`main`,{className:`auth-layout`,children:(0,D.jsxs)(`section`,{className:`auth-card`,children:[(0,D.jsxs)(`div`,{className:`auth-card__intro`,children:[(0,D.jsx)(`p`,{className:`auth-card__eyebrow`,children:`UX Bridge`}),(0,D.jsx)(`h1`,{children:`Page not found`}),(0,D.jsx)(`p`,{className:`auth-card__copy`,children:`The page you tried to open does not exist.`})]}),(0,D.jsx)(`a`,{className:`auth-submit`,href:`/index.html`,children:`Go to Sign In`})]})})}function Ae(){let e=window.location.pathname;return e===`/`||e===`/index.html`?(0,D.jsx)(ye,{}):e===`/reset-password.html`?(0,D.jsx)(be,{}):e===`/home.html`?(0,D.jsx)(ve,{to:`/projects.html`}):e===`/projects.html`?(0,D.jsx)(xe,{}):e===`/admin.html`?(0,D.jsx)(ve,{to:`/user-management.html`}):e===`/user-management.html`?(0,D.jsx)(Se,{}):e===`/profile.html`?(0,D.jsx)(Ce,{}):e===`/overview.html`?(0,D.jsx)(ve,{to:`/project-overview.html`}):e===`/project-overview.html`?(0,D.jsx)(we,{}):e===`/brand-affiliate-mobile.html`||e===`/brand-affiliate-project.html`?(0,D.jsx)(ve,{to:`/project-overview.html`}):e===`/building.html`?(0,D.jsx)(ve,{to:`/building-preview.html`}):e===`/building-preview.html`?(0,D.jsx)(Te,{}):e===`/l1-bonus.html`?(0,D.jsx)(ve,{to:`/l1-bonus-preview.html`}):e===`/l1-bonus-preview.html`?(0,D.jsx)(Ee,{}):e===`/l1-l2-bonus.html`?(0,D.jsx)(ve,{to:`/l1-l2-bonus-preview.html`}):e===`/l1-l2-bonus-preview.html`?(0,D.jsx)(De,{}):e===`/project-page.html`?(0,D.jsx)(ve,{to:`/workspace-page.html`}):e===`/workspace-page.html`?(0,D.jsx)(Oe,{}):(0,D.jsx)(ke,{})}v.createRoot(document.getElementById(`root`)).render((0,D.jsx)(Ae,{}));